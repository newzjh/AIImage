...
public sealed class NcnnLinearCmdPack4GoldenTests
{
    ...
    public void CommandBufferPack4_LinearAndAttentionLayersRejectPlaceholders()
    {
        ...
        var layers = new[]
        {
            "NcnnGemmLayerRepro.cs",
            "NcnnMatMulLayerRepro.cs",
            "NcnnInnerProductLayerRepro.cs",
            "NcnnLayerNormLayerRepro.cs",
            "NcnnSoftmaxLayerRepro.cs",
            "NcnnReductionLayerRepro.cs",
            "NcnnSdpaLayerRepro.cs",
            "NcnnMultiHeadAttentionLayerRepro.cs"
        };
