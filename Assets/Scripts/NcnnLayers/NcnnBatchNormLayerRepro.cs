...
namespace NcnnCompute
{
    public sealed class NcnnBatchNormLayerRepro : NcnnBaseLayerRepro
    {
        ...
        public override NcnnRepro.LayerLoadMetrics LoadLayer(NcnnRepro owner, NcnnParamModel.Layer layer, NcnnBinReader br) => owner.LoadBatchNormLayer(layer, br);
        public override void ExecuteBuffer(NcnnRepro owner, NcnnParamModel.Layer layer, NcnnLayerBufferContext context) => owner.ExecuteBatchNormBufferLayer(layer, context);
    }

    public partial class NcnnRepro
    {
        internal LayerLoadMetrics LoadBatchNormLayer(NcnnParamModel.Layer layer, NcnnBinReader br)
        {
        ...
        internal void ExecuteBatchNormBufferLayer(NcnnParamModel.Layer layer, NcnnLayerBufferContext context)
        {
