...
namespace NcnnCompute
{
    public sealed class NcnnSqueezeLayerRepro : NcnnBaseLayerRepro
    {
        ...
        public override void ExecuteBuffer(NcnnRepro owner, NcnnParamModel.Layer layer, NcnnLayerBufferContext context) => owner.ExecuteSqueezeBufferLayer(layer, context);
    }

    public partial class NcnnRepro
    {
        internal void ExecuteSqueezeBufferLayer(NcnnParamModel.Layer layer, NcnnLayerBufferContext context)
        {
