...
namespace NcnnCompute
{
    public sealed class NcnnEmbedLayerRepro : NcnnBaseLayerRepro
    {
        ...
        public override NcnnRepro.LayerLoadMetrics LoadLayer(NcnnRepro owner, NcnnParamModel.Layer layer, NcnnBinReader br) => owner.LoadEmbedLayer(layer, br);
        public override void ExecuteBuffer(NcnnRepro owner, NcnnParamModel.Layer layer, NcnnLayerBufferContext context) => owner.ExecuteEmbedBufferLayer(layer, context);
    }

    public partial class NcnnRepro
    {
        internal LayerLoadMetrics LoadEmbedLayer(NcnnParamModel.Layer layer, NcnnBinReader br)
        {
        ...
        internal void ExecuteEmbedBufferLayer(NcnnParamModel.Layer layer, NcnnLayerBufferContext context)
        {
