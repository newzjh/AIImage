...
namespace NcnnCompute
{
    public sealed class NcnnExpandDimsLayerRepro : NcnnBaseLayerRepro
    {
        ...
        public override void ExecuteBuffer(NcnnRepro owner, NcnnParamModel.Layer layer, NcnnLayerBufferContext context) => owner.ExecuteExpandDimsBufferLayer(layer, context);
    }

    public partial class NcnnRepro
    {
        internal void ExecuteExpandDimsBufferLayer(NcnnParamModel.Layer layer, NcnnLayerBufferContext context)
        {
