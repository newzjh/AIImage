...
namespace NcnnCompute
{
    public sealed class NcnnGemmLayerRepro : NcnnBaseLayerRepro
    {
        ...
        public override NcnnRepro.LayerLoadMetrics LoadLayer(NcnnRepro owner, NcnnParamModel.Layer layer, NcnnBinReader br) => owner.LoadGemmLayer(layer, br);
        public override void ExecuteBuffer(NcnnRepro owner, NcnnParamModel.Layer layer, NcnnLayerBufferContext context) => owner.ExecuteGemmBufferLayer(layer, context);
    }

    public partial class NcnnRepro
    {
        internal LayerLoadMetrics LoadGemmLayer(NcnnParamModel.Layer layer, NcnnBinReader br)
        {
        ...
        internal void ExecuteGemmBufferLayer(NcnnParamModel.Layer layer, NcnnLayerBufferContext context)
        {
