...
namespace NcnnCompute
{
    public sealed class NcnnGroupNormLayerRepro : NcnnBaseLayerRepro
    {
        ...
        public override NcnnRepro.LayerLoadMetrics LoadLayer(NcnnRepro owner, NcnnParamModel.Layer layer, NcnnBinReader br) => owner.LoadGroupNormLayer(layer, br);
        public override void ExecuteBuffer(NcnnRepro owner, NcnnParamModel.Layer layer, NcnnLayerBufferContext context) => owner.ExecuteGroupNormBufferLayer(layer, context);
    }

    public partial class NcnnRepro
    {
        internal LayerLoadMetrics LoadGroupNormLayer(NcnnParamModel.Layer layer, NcnnBinReader br)
        {
        ...
        internal void ExecuteGroupNormBufferLayer(NcnnParamModel.Layer layer, NcnnLayerBufferContext context)
        {
