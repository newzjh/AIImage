...
namespace NcnnCompute
{
    public sealed class NcnnSliceLayerRepro : NcnnBaseLayerRepro
    {
        ...
        public override void ExecuteBuffer(NcnnRepro owner, NcnnParamModel.Layer layer, NcnnLayerBufferContext context) => owner.ExecuteSliceBufferLayer(layer, context);
    }

    public partial class NcnnRepro
    {
        internal void ExecuteSliceBufferLayer(NcnnParamModel.Layer layer, NcnnLayerBufferContext context)
        {
