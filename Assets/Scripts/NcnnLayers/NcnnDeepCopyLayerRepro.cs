...
namespace NcnnCompute
{
    ...
    public sealed class NcnnDeepCopyLayerRepro : NcnnBaseLayerRepro
    {
        public NcnnDeepCopyLayerRepro()
            : base(NcnnLayerTypes.DeepCopy, supportsBufferPath: true, supportsCommandBufferPath: true)
        {
        }
