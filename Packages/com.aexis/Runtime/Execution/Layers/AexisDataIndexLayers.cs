    ...
    public sealed class AexisNonZeroLayer : AexisBaseLayer
    {
        ...
        internal static void ExecuteRender(AexisGraphSession owner, AexisGraphModel.Layer layer, AexisLayerBufferContext context, bool compress)
        {
            ...
            try
            {
                ...
                if (compress)
                    owner.Ops.AexisCompressLinearMat(values.texture, values.logicalShape, values.storageShape, condition.texture, condition.logicalShape, condition.storageShape, capacity, output, count);
                else
                    owner.Ops.AexisNonZeroLinearMat(values.texture, values.logicalShape, values.storageShape, capacity, output, count);
        ...
        internal static void ExecuteCmd(AexisGraphSession owner, AexisGraphModel.Layer layer, AexisLayerCommandBufferContext context, bool compress)
        {
            ...
            try
            {
                ...
                if (compress)
                    owner.Ops.AexisCompressLinearMat(context.commandBuffer, values.texture, values.logicalShape, values.storageShape, condition.texture, condition.logicalShape, condition.storageShape, capacity, output, count);
                else
                    owner.Ops.AexisNonZeroLinearMat(context.commandBuffer, values.texture, values.logicalShape, values.storageShape, capacity, output, count);
