...
namespace Aexis.Execution
{
    ...
    public sealed class AexisLRNLayer : AexisBaseLayer
    {
        public AexisLRNLayer()
            : base(AexisLayerTypes.LRN, supportsBufferPath: true, supportsCommandBufferPath: true)
        {
        }
        ...
        {
            owner._extraPacks[layer.name] = new AexisGraphSession.LrnPack
            {
...
#pragma warning restore CS0618
        ...
        public override void ExecuteComputeBufferPath(AexisGraphSession owner, AexisGraphModel.Layer layer, AexisLayerBufferContext context)
        {
            ...
            if (!owner._extraPacks.TryGetValue(layer.name, out var packObj) || packObj is not AexisGraphSession.LrnPack lp)
