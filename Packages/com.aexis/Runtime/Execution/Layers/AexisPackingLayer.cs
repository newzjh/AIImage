...
namespace Aexis.Execution
{
    ...
    public sealed class AexisPackingLayer : AexisBaseLayer
    {
        ...
        public AexisPackingLayer()
            : base(AexisLayerTypes.Packing, supportsBufferPath: true, supportsCommandBufferPath: true)
        {
        }
...
#pragma warning restore CS0618
        ...
        public override void ExecuteComputeBufferPath(AexisGraphSession owner, AexisGraphModel.Layer layer, AexisLayerBufferContext context)
        {
            ...
            {
                new AexisNoopLayer().ExecuteBuffer(owner, layer, context);
                return;
            }
        ...
        private static bool RequiresPackingTransform(PackingPack pack, AexisGraphModel.Layer layer)
        {
