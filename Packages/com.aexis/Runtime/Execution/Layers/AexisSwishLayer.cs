...
namespace Aexis.Execution
{
    ...
    public sealed class AexisSwishLayer : AexisBaseLayer
    {
        public AexisSwishLayer() : base(AexisLayerTypes.Swish, supportsBufferPath: true, supportsCommandBufferPath: true) { }
...
#pragma warning restore CS0618
        ...
        public override void ExecuteComputeBufferPath(AexisGraphSession owner, AexisGraphModel.Layer layer, AexisLayerBufferContext context)
        {
            ...
            var outTensor = owner.RentTempTensorBuffer(
                ...
                srcView?.d ?? 1,
                srcView?.c ?? 1);
            owner.Ops.SwishBuf(srcBuf, srcBuf.count, outTensor.buffer);
        ...
        public override void ExecuteRenderTexturePath(AexisGraphSession owner, AexisGraphModel.Layer layer, AexisLayerBufferContext context)
        {
            ...
            if (!AexisGraphSession.TryGetExistingTexture(textureBlobs, textureShapes, layer.bottomNames[0], out var srcTex, out var srcShape) || srcShape.dims > 3)
                throw new InvalidOperationException("Swish render-texture path requires existing <=3D texture input: " + layer.name);
            ...
            if (AexisGraphSession.IsStrictLinearMatTexture(srcTex))
            {
                ...
                owner.Ops.SwishLinearMat(srcTex.texture, outRt);
        ...
        public override void ExecuteCommandBuffer(AexisGraphSession owner, AexisGraphModel.Layer layer, AexisLayerCommandBufferContext context)
        {
                        ...
                        do
                        {
                                                ...
                                                if (AexisGraphSession.IsStrictLinearMatTexture(src) && srcShape.dims <= 2)
                                                {
                                                    ...
                                                    owner.Ops.SwishLinearMat(cmd, src.texture, outMat);
