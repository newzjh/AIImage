...
namespace Aexis.Execution
{
    ...
    public sealed class AexisConvolutionDepthWiseLayer : AexisBaseLayer
    {
        public AexisConvolutionDepthWiseLayer() : base(AexisLayerTypes.ConvolutionDepthWise, supportsBufferPath: true, supportsCommandBufferPath: true) { }
...
#pragma warning restore CS0618
        ...
        public override void ExecuteRenderTexturePath(AexisGraphSession owner, AexisGraphModel.Layer layer, AexisLayerBufferContext context)
        {
            ...
            else
            {
                ...
                src = new AexisGraphSession.TensorRef
                {
            ...
            textureShapes[layer.topNames[0]] = new AexisGraphSession.BufferShape(3, outWTex, outHTex, 1, conv.outC);
        ...
        private static bool SupportsDepthWiseTexturePath(AexisGraphSession.ConvPack conv)
        {
            return conv != null
                && conv.isDepthWise
                && conv.group > 0
