...
namespace Aexis.Execution
{
    ...
    public sealed class AexisPixelShuffleLayer : AexisBaseLayer
    {
        public AexisPixelShuffleLayer()
            : base(AexisLayerTypes.PixelShuffle, supportsBufferPath: true, supportsCommandBufferPath: true)
        {
        }
...
#pragma warning restore CS0618
        ...
        public override void ExecuteCommandBuffer(AexisGraphSession owner, AexisGraphModel.Layer layer, AexisLayerCommandBufferContext context)
        {
            ...
            var divisor = upscaleFactor * upscaleFactor;
            var outShape = new AexisGraphSession.BufferShape(
                3,
        ...
        private static bool CanUsePack4PixelShuffle(AexisGraphSession.TensorRef src, AexisGraphSession.BufferShape srcShape, int upscaleFactor)
        {
            return src != null
                && src.texture != null
                && srcShape.dims == 3
        ...
        private static bool CanUsePack4PixelShuffle(AexisGraphSession.CmdTensorRef src, AexisGraphSession.BufferShape srcShape, int upscaleFactor)
        {
            return src != null
                && src.texture != null
                && srcShape.dims == 3
