...
namespace Aexis.Execution
{
    ...
    public sealed class AexisDeconvolutionDepthWiseLayer : AexisBaseLayer
    {
        public AexisDeconvolutionDepthWiseLayer()
            : base(AexisLayerTypes.DeconvolutionDepthWise, supportsBufferPath: true, supportsCommandBufferPath: true)
        {
        }
...
#pragma warning restore CS0618
        ...
        public override void ExecuteRenderTexturePath(AexisGraphSession owner, AexisGraphModel.Layer layer, AexisLayerBufferContext context)
        {
            ...
            var outShape = new AexisGraphSession.BufferShape(3, outW, outH, 1, deconv.outC);
            RenderTexture output = null;
            try
            {
                output = owner.RentTempArray(outW, outH, deconv.outPacks, AexisGraphSession.ResolveTensorTextureFormat(outShape.dims));
                owner.Ops.DeconvolutionDepthWisePack4(
                    ...
                    deconv.activationSlope,
                    output);
                AexisGraphSession.SetTextureBlob(textureBlobs, textureShapes, layer.topNames[0], output, outShape, outShape);
                output = null;
            }
            finally
            {
        ...
        public override void ExecuteCommandBuffer(AexisGraphSession owner, AexisGraphModel.Layer layer, AexisLayerCommandBufferContext context)
        {
            ...
            try
            {
                output = owner.RentTempArray(cmd, outW, outH, deconv.outPacks, AexisGraphSession.ResolveTensorTextureFormat(outShape.dims));
        ...
        private static bool CanUsePack4DepthWiseDeconvolution(AexisGraphSession.DeconvPack deconv)
        {
            return deconv != null
                && deconv.inC > 0
                && deconv.outC > 0
