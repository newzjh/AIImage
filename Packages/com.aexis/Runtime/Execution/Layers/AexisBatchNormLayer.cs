...
namespace Aexis.Execution
{
    ...
    public sealed class AexisBatchNormLayer : AexisBaseLayer
    {
        public AexisBatchNormLayer() : base(AexisLayerTypes.BatchNorm, supportsBufferPath: true, supportsCommandBufferPath: true) { }
        ...
        public override AexisGraphSession.LayerLoadMetrics LoadLayer(AexisGraphSession owner, AexisGraphModel.Layer layer, AexisWeightReader br)
        {
                        ...
                        var phaseSw = new Stopwatch();
                                        ...
                                        var bp = new AexisGraphSession.BatchNormPack();
                                        ...
                                        var a4 = AexisGraphSession.PackBiasToO4(a, bp.channels, packs);
                                        var b4 = AexisGraphSession.PackBiasToO4(b, bp.channels, packs);
                                        bp.biasA = AexisGraphSession.NewBuffer(a);
                                        bp.scaleB = AexisGraphSession.NewBuffer(b);
