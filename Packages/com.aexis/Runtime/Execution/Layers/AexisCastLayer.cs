...
namespace Aexis.Execution
{
    ...
    public sealed class AexisCastLayer : AexisBaseLayer
    {
        public AexisCastLayer()
            : base(AexisLayerTypes.Cast, supportsBufferPath: true, supportsCommandBufferPath: true)
        {
        }
