...
namespace Aexis.Execution
{
    ...
    public sealed class AexisSqueezeLayer : AexisBaseLayer
    {
        public AexisSqueezeLayer() : base(AexisLayerTypes.Squeeze, supportsBufferPath: true, supportsCommandBufferPath: true) { }
        ...
        public override void ExecuteComputeBufferPath(AexisGraphSession owner, AexisGraphModel.Layer layer, AexisLayerBufferContext context)
        {
            ...
            var squeezed = AexisGraphSession.ResolveSqueezeView(srcTensor, layer);
        ...
        public override void ExecuteRenderTexturePath(AexisGraphSession owner, AexisGraphModel.Layer layer, AexisLayerBufferContext context)
        {
            ...
            if (hasTexture)
            {
                var sourceContract = AexisGraphSession.GetTextureContract(textureShapes, srcTex, layer.bottomNames[0]);
                var srcShape = sourceContract.LogicalShape;
                var outShape = AexisGraphSession.ResolveSqueezeShape(srcShape, layer);
                textureBlobs[layer.topNames[0]] = AexisGraphSession.CreateTextureAlias(srcTex, outShape, sourceContract.StorageShape);
            ...
            if (hasBuffer)
            {
                ...
                var squeezed = AexisGraphSession.ResolveSqueezeView(srcView, layer);
