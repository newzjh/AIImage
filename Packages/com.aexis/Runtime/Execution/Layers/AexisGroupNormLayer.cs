...
namespace Aexis.Execution
{
    ...
    public sealed class AexisGroupNormLayer : AexisBaseLayer
    {
        public AexisGroupNormLayer() : base(AexisLayerTypes.GroupNorm, supportsBufferPath: true, supportsCommandBufferPath: true) { }
        ...
        public override void ExecuteBuffer(AexisGraphSession owner, AexisGraphModel.Layer layer, AexisLayerBufferContext context)
        {
            ...
            if (owner.EnableGroupNormTexturePath
                ...
                && AexisGraphSession.TryGetExistingTexture(
...
#pragma warning restore CS0618
        ...
        public override void ExecuteRenderTexturePath(AexisGraphSession owner, AexisGraphModel.Layer layer, AexisLayerBufferContext context)
        {
            ...
            else if (AexisGraphSession.CanUseGroupNormPack4Path(srcTex, srcShape, gp))
            {
        ...
        private static void ExecuteLinearMatRenderTexturePath(
            ...
            AexisGraphSession.GroupNormPack gp,
            AexisGraphSession.TensorRef srcTex,
            ...
            Dictionary<string, AexisGraphSession.BufferShape> textureShapes)
        {
            ...
            try
            {
                ...
                linearOut = owner.RentTempMat(storageShape.w, storageShape.h, AexisGraphSession.ResolveLinearMatTextureFormat());
                owner.Ops.ReshapePack4ToLinearMat(
                    ...
                    pack4Shape.dims,
                    linearOut);
                AexisGraphSession.SetTextureBlob(textureBlobs, textureShapes, layer.topNames[0], linearOut, srcShape, storageShape);
            ...
            Dictionary<string, AexisGraphSession.BufferShape> shapes)
        {
            ...
            try
            {
                ...
                var linearOut = owner.RentTempMat(cmd, storageShape.w, storageShape.h, AexisGraphSession.ResolveLinearMatTextureFormat());
                owner.Ops.ReshapePack4ToLinearMat(
                    cmd,
                    outArr,
                    pack4Shape.w,
                    ...
                    pack4Shape.dims,
                    linearOut);
                blobs[layer.topNames[0]] = AexisGraphSession.CreateCmdTensorRef(linearOut, srcShape, storageShape, owned: true);
                if (shapes != null)
                    shapes[layer.topNames[0]] = srcShape;
                owner.DebugLog?.Invoke(
        ...
        private static bool CanUseLinearMatPath(AexisGraphSession.TensorRef src, AexisGraphSession.BufferShape srcShape, AexisGraphSession.GroupNormPack gp)
        {
        ...
        private static bool CanUseLinearMatCmdPath(AexisGraphSession.CmdTensorRef src, AexisGraphSession.BufferShape srcShape, AexisGraphSession.GroupNormPack gp)
        {
            if (src == null || src.texture == null || !AexisGraphSession.IsStrictLinearMatTexture(src))
                return false;
        ...
        private static AexisGraphSession.BufferShape BuildLinearMatPack4Shape(AexisGraphSession.BufferShape srcShape, AexisGraphSession.GroupNormPack gp)
        {
            if (srcShape.dims != 2)
            ...
            return new AexisGraphSession.BufferShape(3, srcShape.w, 1, 1, gp.channels);
        }
