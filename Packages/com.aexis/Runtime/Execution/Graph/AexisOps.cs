...
namespace Aexis.Execution
{
    ...
    public sealed class AexisOps : IDisposable
    {
        ...
        private readonly int _kPackRgbToNhwcPack4;
        private readonly int _kPackMaskToNhwcPack4;
        ...
        private readonly int _kCopyToPack4;
        ...
        private readonly int _kPack4SpatialToPack4Linear;
        private readonly int _kPack4ReorderMergeRows;
        private readonly int _kLinearMatReorderMergeRows;
        ...
        private readonly int _kPack4ToRgbScaled;
        private readonly int _kNhwcPack4ToRgbScaled;
        ...
        private readonly int _kPooling1DPack4;
        ...
        private readonly int _kPermutePack4CdhwFoldD;
        private readonly int _kPermutePack4FoldDToCdhw;
        ...
        private readonly int _kReshapeLinearMat2D;
        ...
        private readonly int _kGemm2DPack4TiledTextureAFromLinear;
        private readonly int _kGemm2DPack4TiledTextureAFromPack4;
        ...
        private readonly int _kReductionPack4Width;
        private readonly int _kReductionPack4Channel;
        ...
        private readonly int _kRmsNormPack4LinearMat;
        ...
        public AexisOps()
        {
            ...
            {
                UnityEngine.Debug.LogWarning("[AexisOps] Fast-zero probe enabled: gemm="
            ...
            {
                UnityEngine.Debug.LogWarning("[AexisOps] Gemm texture outs/thread probe enabled: "
            ...
            {
                UnityEngine.Debug.LogWarning("[AexisOps] Gemm pack4-linear output packs/thread override enabled: "
                    + _gemmPack4LinearOutPacksPerThread.ToString(CultureInfo.InvariantCulture)
                    + ". Default optimized pack4 RT path uses 2.");
            }
        }

        public void TextureToBuffer3(Texture src, int offsetX, int offsetY, AexisTensorBuffer output)
        {
        ...
        public void BufferToTexture3(AexisTensorBuffer input, RenderTexture output)
        {
        ...
        {
            PackRgbToPack4(src, offsetX, offsetY, sx, sy, dstPack4, flipY, 1f);
        }

        public void PackRgbToPack4(Texture src, int offsetX, int offsetY, float sx, float sy, RenderTexture dstPack4, bool flipY, float valueScale)
        {
            if (src == null) throw new ArgumentNullException(nameof(src));
            _cs.SetInt("_OffsetX", offsetX);
            _cs.SetInt("_OffsetY", offsetY);
        ...
        public void PackRgbToNhwcPack4(Texture src, int offsetX, int offsetY, float sx, float sy, RenderTexture dstPack4, bool flipY, float valueScale)
        {
            if (src == null) throw new ArgumentNullException(nameof(src));
        ...
        public void PackMaskToNhwcPack4(Texture src, int offsetX, int offsetY, float sx, float sy, RenderTexture dstPack4, bool flipY, float maskThreshold = 0.5f)
        {
            if (src == null) throw new ArgumentNullException(nameof(src));
            if (dstPack4 == null) throw new ArgumentNullException(nameof(dstPack4));
            _cs.SetInt("_OffsetX", offsetX);
        ...
        {
            PackRgbToPack4(cmd, src, offsetX, offsetY, sx, sy, dstPack4, flipY, 1f);
        }

        public void PackRgbToPack4(CommandBuffer cmd, Texture src, int offsetX, int offsetY, float sx, float sy, ComputeTexture dstPack4, bool flipY, float valueScale)
        {
            if (src == null) throw new ArgumentNullException(nameof(src));
        ...
        public void SentisWhereLinearMat(
            ...
            AexisGraphSession.BufferShape aStorageShape,
            RenderTexture b,
            AexisGraphSession.BufferShape bShape,
            AexisGraphSession.BufferShape bStorageShape,
            AexisGraphSession.BufferShape outShape,
            AexisGraphSession.BufferShape outStorageShape,
            RenderTexture output)
        {
        ...
        public void AddBiasPack4(CommandBuffer cmd, ComputeTexture input, ComputeBuffer bias4, int packs, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (bias4 == null) throw new ArgumentNullException(nameof(bias4));
            if (output == null) throw new ArgumentNullException(nameof(output));
            cmd.SetComputeIntParam(_cs, "_BiasPacks", packs);
            cmd.SetComputeBufferParam(_cs, _kAddBiasPack4, "_Bias4", bias4);
            cmd.SetComputeTextureParam(_cs, _kAddBiasPack4, "_TexIn0Arr", input.nameID);
            cmd.SetComputeTextureParam(_cs, _kAddBiasPack4, "_TexOut0Arr", output.nameID);
            Dispatch3D(cmd, _kAddBiasPack4, output.width, output.height, packs, 8, 8);
        }
        ...
        public void PReluPack4(RenderTexture input, ComputeBuffer slope, int slopeCount, int channelPacks, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            ...
            _cs.SetInt("_PReluSlopePack4Packs", Mathf.Max(1, channelPacks));
            ...
            Dispatch3D(_kPReluPack4, output.width, output.height, ResolveRenderTextureDispatchDepth(output, channelPacks), 8, 8);
        }

        public void PReluPack4(CommandBuffer cmd, ComputeTexture input, ComputeBuffer slope, int slopeCount, int channelPacks, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (slope == null) throw new ArgumentNullException(nameof(slope));
            ...
            cmd.SetComputeIntParam(_cs, "_PReluSlopePack4Packs", Mathf.Max(1, channelPacks));
            ...
            Dispatch3D(cmd, _kPReluPack4, output.width, output.height, ResolveComputeTextureDispatchDepth(output, channelPacks), 8, 8);
        }
        ...
        public void PermutePack4CdhwFoldD(RenderTexture input, int inW, int inH, int inD, int inC, Vector4Int axes, int outW, int outH, int outD, int outC, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            _cs.SetInt("_PermutePack4CDHWInW", inW);
            ...
            _cs.SetInt("_PermutePack4CDHWAxis2", axes.z);
            _cs.SetInt("_PermutePack4CDHWAxis3", axes.w);
            _cs.SetTexture(_kPermutePack4CdhwFoldD, "_TexIn0Arr", input);
            _cs.SetTexture(_kPermutePack4CdhwFoldD, "_TexOut0Arr", output);
            Dispatch3D(_kPermutePack4CdhwFoldD, output.width, output.height, ResolveRenderTextureDispatchDepth(output, Mathf.Max(1, Mathf.CeilToInt(outC / 4f))), 8, 8);
        }

        public void PermutePack4CdhwFoldD(CommandBuffer cmd, ComputeTexture input, int inW, int inH, int inD, int inC, Vector4Int axes, int outW, int outH, int outD, int outC, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ...
            cmd.SetComputeIntParam(_cs, "_PermutePack4CDHWAxis2", axes.z);
            cmd.SetComputeIntParam(_cs, "_PermutePack4CDHWAxis3", axes.w);
            cmd.SetComputeTextureParam(_cs, _kPermutePack4CdhwFoldD, "_TexIn0Arr", input.nameID);
            cmd.SetComputeTextureParam(_cs, _kPermutePack4CdhwFoldD, "_TexOut0Arr", output.nameID);
            Dispatch3D(cmd, _kPermutePack4CdhwFoldD, output.width, output.height, Mathf.Max(1, Mathf.CeilToInt(outC / 4f)), 8, 8);
        }

        public void PermutePack4FoldDToCdhw(RenderTexture input, int inW, int inH, int inD, int inC, Vector4Int axes, int outW, int outH, int outD, int outC, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            _cs.SetInt("_PermutePack4CDHWInW", inW);
            ...
            _cs.SetInt("_PermutePack4CDHWAxis2", axes.z);
            _cs.SetInt("_PermutePack4CDHWAxis3", axes.w);
            _cs.SetTexture(_kPermutePack4FoldDToCdhw, "_TexIn0Arr", input);
            _cs.SetTexture(_kPermutePack4FoldDToCdhw, "_TexOut0Arr", output);
            Dispatch3D(_kPermutePack4FoldDToCdhw, output.width, output.height, ResolveRenderTextureDispatchDepth(output, Mathf.Max(1, outD * Mathf.CeilToInt(outC / 4f))), 8, 8);
        }

        public void PermutePack4FoldDToCdhw(CommandBuffer cmd, ComputeTexture input, int inW, int inH, int inD, int inC, Vector4Int axes, int outW, int outH, int outD, int outC, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ...
            cmd.SetComputeIntParam(_cs, "_PermutePack4CDHWAxis2", axes.z);
            cmd.SetComputeIntParam(_cs, "_PermutePack4CDHWAxis3", axes.w);
            cmd.SetComputeTextureParam(_cs, _kPermutePack4FoldDToCdhw, "_TexIn0Arr", input.nameID);
            cmd.SetComputeTextureParam(_cs, _kPermutePack4FoldDToCdhw, "_TexOut0Arr", output.nameID);
            Dispatch3D(cmd, _kPermutePack4FoldDToCdhw, output.width, output.height, Mathf.Max(1, outD * Mathf.CeilToInt(outC / 4f)), 8, 8);
        }
        ...
        public void ReshapeLinearMat2D(RenderTexture input, int inputWidth, int inputHeight, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            if (input.dimension != TextureDimension.Tex2D || output.dimension != TextureDimension.Tex2D)
                throw new InvalidOperationException("ReshapeLinearMat2D requires Texture2D inputs and outputs.");
            if (inputWidth <= 0 || inputHeight <= 0 || inputWidth * inputHeight != output.width * output.height)
                throw new InvalidOperationException("ReshapeLinearMat2D element count mismatch.");
            _cs.SetInt("_LinearReshapeInW", inputWidth);
            _cs.SetInt("_LinearReshapeInH", inputHeight);
            _cs.SetTexture(_kReshapeLinearMat2D, "_LinearIn0", input);
            _cs.SetTexture(_kReshapeLinearMat2D, "_LinearOut0", output);
            Dispatch2D(_kReshapeLinearMat2D, output.width, output.height, 8, 8);
        }

        public void ReshapeLinearMat2D(CommandBuffer cmd, ComputeTexture input, int inputWidth, int inputHeight, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            if (inputWidth <= 0 || inputHeight <= 0 || inputWidth * inputHeight != output.width * output.height)
                throw new InvalidOperationException("ReshapeLinearMat2D element count mismatch.");
            cmd.SetComputeIntParam(_cs, "_LinearReshapeInW", inputWidth);
            cmd.SetComputeIntParam(_cs, "_LinearReshapeInH", inputHeight);
            cmd.SetComputeTextureParam(_cs, _kReshapeLinearMat2D, "_LinearIn0", input.nameID);
            cmd.SetComputeTextureParam(_cs, _kReshapeLinearMat2D, "_LinearOut0", output.nameID);
            Dispatch2D(cmd, _cs, _kReshapeLinearMat2D, output.width, output.height, 8, 8);
        }
        ...
        public void Gemm2DPack4LinearTextureA(RenderTexture a, bool inputPacked, ComputeBuffer b, ComputeBuffer c, int m, int n, int k, bool transB, float alpha, float beta, bool useC, int broadcastTypeC, RenderTexture output)
        {
            ...
            _cs.SetFloat("_MatAlpha", alpha);
            _cs.SetFloat("_MatBeta", beta);
            _cs.SetInt("_GemmTexAInW", inputPacked ? a.width : k);
            _cs.SetInt("_GemmTexAInH", m);
        ...
        public void Gemm2DPack4LinearTextureA(CommandBuffer cmd, ComputeTexture a, bool inputPacked, ComputeBuffer b, ComputeBuffer c, int m, int n, int k, bool transB, float alpha, float beta, bool useC, int broadcastTypeC, ComputeTexture output)
        {
            ...
            cmd.SetComputeFloatParam(_cs, "_MatAlpha", alpha);
            cmd.SetComputeFloatParam(_cs, "_MatBeta", beta);
            cmd.SetComputeIntParam(_cs, "_GemmTexAInW", inputPacked ? a.width : k);
            cmd.SetComputeIntParam(_cs, "_GemmTexAInH", m);
        ...
        public void Gemm2DPack4TiledTextureAFromLinear(RenderTexture a, ComputeBuffer b, ComputeBuffer c, int m, int n, int k, bool transB, float alpha, float beta, bool useC, int broadcastTypeC, int tileRowsPerMatrix, RenderTexture output)
        {
            if (a == null) throw new ArgumentNullException(nameof(a));
            if (b == null) throw new ArgumentNullException(nameof(b));
            if (output == null) throw new ArgumentNullException(nameof(output));
            if (m <= 0 || n <= 0 || k <= 0 || tileRowsPerMatrix <= 0) throw new ArgumentOutOfRangeException(nameof(m));
            if (useC && c == null) throw new ArgumentNullException(nameof(c));
            ...
            _cs.SetInt("_GemmTexAInW", k);
            _cs.SetInt("_GemmTexAInH", m);
            _cs.SetInt("_GemmPack4TiledRowsPerMatrix", tileRowsPerMatrix);
            _cs.SetTexture(_kGemm2DPack4TiledTextureAFromLinear, "_LinearIn0", a);
            SetTextureGemmWeights(_kGemm2DPack4TiledTextureAFromLinear, b);
            _cs.SetBuffer(_kGemm2DPack4TiledTextureAFromLinear, "_MatC", useC ? c : b);
            _cs.SetTexture(_kGemm2DPack4TiledTextureAFromLinear, "_TexOut0Arr", output);
            Dispatch3D(_kGemm2DPack4TiledTextureAFromLinear, output.width, output.height, 1, 8, 8);
        }

        public void Gemm2DPack4TiledTextureAFromLinear(CommandBuffer cmd, ComputeTexture a, ComputeBuffer b, ComputeBuffer c, int m, int n, int k, bool transB, float alpha, float beta, bool useC, int broadcastTypeC, int tileRowsPerMatrix, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (a == null) throw new ArgumentNullException(nameof(a));
            if (b == null) throw new ArgumentNullException(nameof(b));
            ...
            cmd.SetComputeIntParam(_cs, "_GemmTexAInW", k);
            cmd.SetComputeIntParam(_cs, "_GemmTexAInH", m);
            cmd.SetComputeIntParam(_cs, "_GemmPack4TiledRowsPerMatrix", tileRowsPerMatrix);
            cmd.SetComputeTextureParam(_cs, _kGemm2DPack4TiledTextureAFromLinear, "_LinearIn0", a.nameID);
            SetTextureGemmWeights(cmd, _kGemm2DPack4TiledTextureAFromLinear, b);
            cmd.SetComputeBufferParam(_cs, _kGemm2DPack4TiledTextureAFromLinear, "_MatC", useC ? c : b);
            cmd.SetComputeTextureParam(_cs, _kGemm2DPack4TiledTextureAFromLinear, "_TexOut0Arr", output.nameID);
            Dispatch3D(cmd, _kGemm2DPack4TiledTextureAFromLinear, output.width, output.height, 1, 8, 8);
        }

        public void Gemm2DPack4TiledTextureAFromPack4(RenderTexture a, ComputeBuffer b, ComputeBuffer c, int m, int n, int k, bool transB, float alpha, float beta, bool useC, int broadcastTypeC, int tileRowsPerMatrix, RenderTexture output)
        {
            if (a == null) throw new ArgumentNullException(nameof(a));
            if (b == null) throw new ArgumentNullException(nameof(b));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ...
            _cs.SetFloat("_MatAlpha", alpha);
            _cs.SetFloat("_MatBeta", beta);
            _cs.SetInt("_GemmTexAInW", Mathf.CeilToInt(k / 4f));
            _cs.SetInt("_GemmTexAInH", m);
            _cs.SetInt("_GemmPack4TiledRowsPerMatrix", tileRowsPerMatrix);
            _cs.SetTexture(_kGemm2DPack4TiledTextureAFromPack4, "_TexIn0Arr", a);
            SetTextureGemmWeights(_kGemm2DPack4TiledTextureAFromPack4, b);
            _cs.SetBuffer(_kGemm2DPack4TiledTextureAFromPack4, "_MatC", useC ? c : b);
            _cs.SetTexture(_kGemm2DPack4TiledTextureAFromPack4, "_TexOut0Arr", output);
            Dispatch3D(_kGemm2DPack4TiledTextureAFromPack4, output.width, output.height, 1, 8, 8);
        }

        public void Gemm2DPack4TiledTextureAFromPack4(CommandBuffer cmd, ComputeTexture a, ComputeBuffer b, ComputeBuffer c, int m, int n, int k, bool transB, float alpha, float beta, bool useC, int broadcastTypeC, int tileRowsPerMatrix, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (a == null) throw new ArgumentNullException(nameof(a));
            if (b == null) throw new ArgumentNullException(nameof(b));
            ...
            cmd.SetComputeFloatParam(_cs, "_MatAlpha", alpha);
            cmd.SetComputeFloatParam(_cs, "_MatBeta", beta);
            cmd.SetComputeIntParam(_cs, "_GemmTexAInW", Mathf.CeilToInt(k / 4f));
            cmd.SetComputeIntParam(_cs, "_GemmTexAInH", m);
            cmd.SetComputeIntParam(_cs, "_GemmPack4TiledRowsPerMatrix", tileRowsPerMatrix);
            cmd.SetComputeTextureParam(_cs, _kGemm2DPack4TiledTextureAFromPack4, "_TexIn0Arr", a.nameID);
            SetTextureGemmWeights(cmd, _kGemm2DPack4TiledTextureAFromPack4, b);
            cmd.SetComputeBufferParam(_cs, _kGemm2DPack4TiledTextureAFromPack4, "_MatC", useC ? c : b);
            cmd.SetComputeTextureParam(_cs, _kGemm2DPack4TiledTextureAFromPack4, "_TexOut0Arr", output.nameID);
            Dispatch3D(cmd, _kGemm2DPack4TiledTextureAFromPack4, output.width, output.height, 1, 8, 8);
        }
        ...
        public void NhwcPack4ToRgbScaled(RenderTexture inputPack4, RenderTexture outputRgb, float scale, float bias = 0f, bool flipY = false)
        {
            if (inputPack4 == null) throw new ArgumentNullException(nameof(inputPack4));
            if (outputRgb == null) throw new ArgumentNullException(nameof(outputRgb));
            _cs.SetInt("_FlipY", flipY ? 1 : 0);
            _cs.SetFloat("_OutputValueScale", scale);
            _cs.SetFloat("_OutputValueBias", bias);
            _cs.SetTexture(_kNhwcPack4ToRgbScaled, "_TexIn0Arr", inputPack4);
            _cs.SetTexture(_kNhwcPack4ToRgbScaled, "_RgbOut", outputRgb);
            Dispatch2D(_kNhwcPack4ToRgbScaled, outputRgb.width, outputRgb.height, 32, 32);
        }
        ...
        public void PoolingPack4(RenderTexture input, int packs, int kernelW, int kernelH, int strideW, int strideH, int padLeft, int padTop, int poolType, RenderTexture output, bool includePad = false)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ...
            _cs.SetInt("_PoolIncludePad", includePad ? 1 : 0);
        ...
        public void Pooling1DPack4(RenderTexture input, int inputWidth, int packs, int poolType, int kernel, int stride, int padLeft, bool includePad, bool adaptive, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            if (inputWidth <= 0 || packs <= 0 || kernel <= 0 || stride <= 0) throw new ArgumentOutOfRangeException(nameof(inputWidth));
            _cs.SetInt("_Pool1DInputW", inputWidth);
            _cs.SetInt("_Pool1DType", poolType);
            _cs.SetInt("_Pool1DKernel", kernel);
            _cs.SetInt("_Pool1DStride", stride);
            _cs.SetInt("_Pool1DPadLeft", padLeft);
            _cs.SetInt("_Pool1DIncludePad", includePad ? 1 : 0);
            _cs.SetInt("_Pool1DAdaptive", adaptive ? 1 : 0);
            _cs.SetTexture(_kPooling1DPack4, "_TexIn0Arr", input);
            _cs.SetTexture(_kPooling1DPack4, "_TexOut0Arr", output);
            Dispatch3D(_kPooling1DPack4, output.width, 1, packs, 8, 8);
        }
        ...
        public void PoolingPack4(CommandBuffer cmd, ComputeTexture input, int packs, int kernelW, int kernelH, int strideW, int strideH, int padLeft, int padTop, int poolType, ComputeTexture output, bool includePad = false)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ...
            cmd.SetComputeIntParams(_cs, "_PoolIncludePad", includePad ? 1 : 0);
        ...
        public void Pooling1DPack4(CommandBuffer cmd, ComputeTexture input, int inputWidth, int packs, int poolType, int kernel, int stride, int padLeft, bool includePad, bool adaptive, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            if (inputWidth <= 0 || packs <= 0 || kernel <= 0 || stride <= 0) throw new ArgumentOutOfRangeException(nameof(inputWidth));
            cmd.SetComputeIntParam(_cs, "_Pool1DInputW", inputWidth);
            cmd.SetComputeIntParam(_cs, "_Pool1DType", poolType);
            cmd.SetComputeIntParam(_cs, "_Pool1DKernel", kernel);
            cmd.SetComputeIntParam(_cs, "_Pool1DStride", stride);
            cmd.SetComputeIntParam(_cs, "_Pool1DPadLeft", padLeft);
            cmd.SetComputeIntParam(_cs, "_Pool1DIncludePad", includePad ? 1 : 0);
            cmd.SetComputeIntParam(_cs, "_Pool1DAdaptive", adaptive ? 1 : 0);
            cmd.SetComputeTextureParam(_cs, _kPooling1DPack4, "_TexIn0Arr", input.nameID);
            cmd.SetComputeTextureParam(_cs, _kPooling1DPack4, "_TexOut0Arr", output.nameID);
            Dispatch3D(cmd, _kPooling1DPack4, output.width, 1, packs, 8, 8);
        }

        public void SoftmaxChannelPack4(RenderTexture input, int packs, RenderTexture output, int mode = 0)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void SoftmaxPack4Cdhw(RenderTexture input, int w, int h, int d, int c, RenderTexture output, int axis = 0, int mode = 0)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void SoftmaxPack4Cdhw(CommandBuffer cmd, ComputeTexture input, int w, int h, int d, int c, ComputeTexture output, int axis = 0, int mode = 0)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void SoftmaxLinearMat2D(RenderTexture input, int w, int h, RenderTexture output, int axis = 0, int mode = 0)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            _cs.SetInt("_SoftmaxPack4CDHWW", w);
        ...
        public void SoftmaxLinearMat2D(CommandBuffer cmd, ComputeTexture input, int w, int h, ComputeTexture output, int axis = 0, int mode = 0)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void UnaryOpPack4(RenderTexture input, int packs, int opType, RenderTexture output, int logicalChannels = 0)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            _cs.SetInt("_UnaryOpType", opType);
            _cs.SetInt("_UnaryChannels", logicalChannels);
        ...
        public void UnaryOpPack4(CommandBuffer cmd, ComputeTexture input, int packs, int opType, ComputeTexture output, int logicalChannels = 0)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            cmd.SetComputeIntParam(_cs, "_UnaryOpType", opType);
            cmd.SetComputeIntParam(_cs, "_UnaryChannels", logicalChannels);
        ...
        public void TriluPack4(RenderTexture input, int slices, int diagonal, int upper, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ValidateTriluUpper(upper);
            _cs.SetInt("_TriluK", diagonal);
            _cs.SetInt("_TriluUpper", upper);
            _cs.SetTexture(_kTriluPack4, "_TexIn0Arr", input);
            _cs.SetTexture(_kTriluPack4, "_TexOut0Arr", output);
            Dispatch3D(_kTriluPack4, output.width, output.height, slices, 8, 8);
        }

        public void TriluPack4(
            CommandBuffer cmd,
            ComputeTexture input,
            int slices,
            int diagonal,
            ...
            ComputeTexture output)
        {
            ...
            if (output == null) throw new ArgumentNullException(nameof(output));
            ValidateTriluUpper(upper);
            cmd.SetComputeIntParam(_cs, "_TriluK", diagonal);
            cmd.SetComputeIntParam(_cs, "_TriluUpper", upper);
            cmd.SetComputeTextureParam(_cs, _kTriluPack4, "_TexIn0Arr", input.nameID);
            cmd.SetComputeTextureParam(_cs, _kTriluPack4, "_TexOut0Arr", output.nameID);
            Dispatch3D(cmd, _kTriluPack4, output.width, output.height, ResolveComputeTextureDispatchDepth(output, slices), 8, 8);
        }

        public void TriluLinearMat(RenderTexture input, int diagonal, int upper, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ValidateTriluUpper(upper);
            _cs.SetInt("_TriluK", diagonal);
            _cs.SetInt("_TriluUpper", upper);
            _cs.SetTexture(_kTriluLinearMat, "_LinearIn0", input);
            _cs.SetTexture(_kTriluLinearMat, "_LinearOut0", output);
            Dispatch2D(_kTriluLinearMat, output.width, output.height, 8, 8);
        }

        public void TriluLinearMat(
            CommandBuffer cmd,
            ComputeTexture input,
            int diagonal,
            int upper,
            ComputeTexture output)
        {
            ...
            cmd.SetComputeIntParam(_cs, "_TriluK", diagonal);
            cmd.SetComputeIntParam(_cs, "_TriluUpper", upper);
            cmd.SetComputeTextureParam(_cs, _kTriluLinearMat, "_LinearIn0", input.nameID);
            cmd.SetComputeTextureParam(_cs, _kTriluLinearMat, "_LinearOut0", output.nameID);
            Dispatch2D(cmd, _cs, _kTriluLinearMat, output.width, output.height, 8, 8);
        }

        private static void ValidateTriluUpper(int upper)
        {
            if (upper != 0 && upper != 1)
                throw new ArgumentOutOfRangeException(nameof(upper), "Trilu upper must be 0 or 1.");
        }
        ...
        public void BinaryOpPack4Broadcast(RenderTexture a, RenderTexture b, int packs, int opType, int broadcastMode, RenderTexture output)
        {
            ...
            if (b == null) throw new ArgumentNullException(nameof(b));
            if (output == null) throw new ArgumentNullException(nameof(output));
            if (broadcastMode < 1 || broadcastMode > 8)
        ...
        public void Conv3x3Pack4Winograd23(RenderTexture srcPack4, int inPacks, ComputeBuffer wTm23, ComputeBuffer b4, int outPacks, int biasTerm, int activationType, float activationParam, RenderTexture dstPack4)
        {
            ...
            var blockX = AexisWinograd23.BlockX(w);
            var blockY = AexisWinograd23.BlockY(h);
            var tiles = blockX * blockY;
            var bottomCount = AexisWinograd23.BottomTmCount(w, h, inPacks);
            var topCount = AexisWinograd23.TopTmCount(w, h, outPacks);
            ...
            RenderTexture output)
        {
            if (src == null) throw new ArgumentNullException(nameof(src));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ValidateCopyToPack4(srcW, srcH, srcD, srcC, dstC, offsetW, offsetH, offsetD, offsetC, output.width, output.height, output.volumeDepth);
            var dstPacks = Mathf.Max(1, Mathf.CeilToInt(dstC / 4f));
            _cs.SetInt("_CopyToSrcW", srcW);
            _cs.SetInt("_CopyToSrcH", srcH);
            _cs.SetInt("_CopyToSrcD", srcD);
            _cs.SetInt("_CopyToSrcC", srcC);
            _cs.SetInt("_CopyToDstC", dstC);
            _cs.SetInt("_CopyToDstPacks", dstPacks);
            _cs.SetInt("_CopyToOffsetW", offsetW);
            _cs.SetInt("_CopyToOffsetH", offsetH);
            _cs.SetInt("_CopyToOffsetD", offsetD);
            _cs.SetInt("_CopyToOffsetC", offsetC);
            _cs.SetTexture(_kCopyToPack4, "_TexIn1Arr", src);
            _cs.SetTexture(_kCopyToPack4, "_TexOut0Arr", output);
            Dispatch3D(_kCopyToPack4, srcW, srcH, srcD * dstPacks, 8, 8);
        }
        ...
        public void ConcatSequencePack4Cdhw(
            RenderTexture a,
            RenderTexture b,
            int aHeight,
            int bHeight,
            RenderTexture output)
        {
            ...
            if (b == null) throw new ArgumentNullException(nameof(b));
            if (output == null) throw new ArgumentNullException(nameof(output));
            if (aHeight <= 0 || bHeight <= 0) throw new ArgumentOutOfRangeException(nameof(aHeight));
            if (a.width != b.width || a.width != output.width || a.volumeDepth != b.volumeDepth || a.volumeDepth != output.volumeDepth)
                throw new InvalidOperationException("ConcatSequencePack4Cdhw requires matching width/depth textures.");
            if (output.height < aHeight + bHeight)
                throw new InvalidOperationException("ConcatSequencePack4Cdhw output height is too small.");
            _cs.SetInt("_ConcatSequencePack4CDHWAH", aHeight);
            _cs.SetInt("_ConcatSequencePack4CDHWBH", bHeight);
            _cs.SetTexture(_kConcatSequencePack4Cdhw, "_TexIn0Arr", a);
            _cs.SetTexture(_kConcatSequencePack4Cdhw, "_TexIn1Arr", b);
            _cs.SetTexture(_kConcatSequencePack4Cdhw, "_TexOut0Arr", output);
            Dispatch3D(_kConcatSequencePack4Cdhw, output.width, output.height, Mathf.Max(1, output.volumeDepth), 8, 8);
        }
            ...
            ComputeTexture output)
        {
            ...
            if (output == null) throw new ArgumentNullException(nameof(output));
            if (aHeight <= 0 || bHeight <= 0) throw new ArgumentOutOfRangeException(nameof(aHeight));
            if (a.width != b.width || a.width != output.width || a.depth != b.depth || a.depth != output.depth)
                throw new InvalidOperationException("ConcatSequencePack4Cdhw requires matching width/depth textures.");
            if (output.height < aHeight + bHeight)
                throw new InvalidOperationException("ConcatSequencePack4Cdhw output height is too small.");
            cmd.SetComputeIntParam(_cs, "_ConcatSequencePack4CDHWAH", aHeight);
            cmd.SetComputeIntParam(_cs, "_ConcatSequencePack4CDHWBH", bHeight);
            cmd.SetComputeTextureParam(_cs, _kConcatSequencePack4Cdhw, "_TexIn0Arr", a.nameID);
            cmd.SetComputeTextureParam(_cs, _kConcatSequencePack4Cdhw, "_TexIn1Arr", b.nameID);
            cmd.SetComputeTextureParam(_cs, _kConcatSequencePack4Cdhw, "_TexOut0Arr", output.nameID);
            ...
            ComputeTexture output)
        {
            ...
            if (src == null) throw new ArgumentNullException(nameof(src));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ValidateCopyToPack4(srcW, srcH, srcD, srcC, dstC, offsetW, offsetH, offsetD, offsetC, output.width, output.height, output.depth);
            var dstPacks = Mathf.Max(1, Mathf.CeilToInt(dstC / 4f));
            cmd.SetComputeIntParam(_cs, "_CopyToSrcW", srcW);
            cmd.SetComputeIntParam(_cs, "_CopyToSrcH", srcH);
            cmd.SetComputeIntParam(_cs, "_CopyToSrcD", srcD);
            cmd.SetComputeIntParam(_cs, "_CopyToSrcC", srcC);
            cmd.SetComputeIntParam(_cs, "_CopyToDstC", dstC);
            cmd.SetComputeIntParam(_cs, "_CopyToDstPacks", dstPacks);
            cmd.SetComputeIntParam(_cs, "_CopyToOffsetW", offsetW);
            cmd.SetComputeIntParam(_cs, "_CopyToOffsetH", offsetH);
            cmd.SetComputeIntParam(_cs, "_CopyToOffsetD", offsetD);
            cmd.SetComputeIntParam(_cs, "_CopyToOffsetC", offsetC);
            cmd.SetComputeTextureParam(_cs, _kCopyToPack4, "_TexIn1Arr", src.nameID);
            cmd.SetComputeTextureParam(_cs, _kCopyToPack4, "_TexOut0Arr", output.nameID);
            Dispatch3D(cmd, _kCopyToPack4, srcW, srcH, srcD * dstPacks, 8, 8);
        }

        private static void ValidateCopyToPack4(
            int srcW,
            int srcH,
            int srcD,
            int srcC,
            ...
            int outputDepth)
        {
            if (srcW <= 0 || srcH <= 0 || srcD <= 0 || srcC <= 0 || dstC <= 0)
                throw new ArgumentOutOfRangeException(nameof(srcW), "CopyToPack4 shapes must be positive.");
            if (offsetW < 0 || offsetH < 0 || offsetD < 0 || offsetC < 0
                || offsetW + srcW > outputW || offsetH + srcH > outputH || offsetC + srcC > dstC)
                throw new ArgumentOutOfRangeException(nameof(offsetW), "CopyToPack4 ROI exceeds destination bounds.");
            var dstPacks = Mathf.Max(1, Mathf.CeilToInt(dstC / 4f));
            if ((offsetD + srcD) * dstPacks > Mathf.Max(1, outputDepth))
                throw new ArgumentOutOfRangeException(nameof(offsetD), "CopyToPack4 depth ROI exceeds destination storage.");
        }
        ...
        public void InterpPack4(RenderTexture input, int packs, float scaleX, float scaleY, RenderTexture output, int coordinateTransformMode = 0, bool alignCorners = false)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void InterpPack4(CommandBuffer cmd, ComputeTexture input, int packs, float scaleX, float scaleY, ComputeTexture output, int coordinateTransformMode = 0, bool alignCorners = false)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void PoolingPack4(CommandBuffer cmd, RenderTexture input, int packs, int kernelW, int kernelH, int strideW, int strideH, int padLeft, int padTop, int poolType, RenderTexture output, bool includePad = false)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ...
            cmd.SetComputeIntParam(_cs, "_PoolIncludePad", includePad ? 1 : 0);
        ...
        public void PoolingPack4(CommandBuffer cmd, int inputID, int packs, int kernelW, int kernelH, int strideW, int strideH, int padLeft, int padTop, int poolType, int outputID, int width, int height, bool includePad = false)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            cmd.SetComputeIntParam(_cs, "_PoolKernelW", kernelW);
            cmd.SetComputeIntParam(_cs, "_PoolKernelH", kernelH);
        ...
        public void SoftmaxChannelPack4(CommandBuffer cmd, RenderTexture input, int packs, RenderTexture output, int mode = 0)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void SoftmaxChannelPack4(CommandBuffer cmd, int inputID, int packs, int outputID, int width, int height, int mode = 0)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            cmd.SetComputeIntParam(_cs, "_SoftmaxPacks", packs);
            cmd.SetComputeIntParam(_cs, "_SoftmaxMode", mode);
        ...
        public void UnaryOpPack4(CommandBuffer cmd, RenderTexture input, int packs, int opType, RenderTexture output, int logicalChannels = 0)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void UnaryOpPack4(CommandBuffer cmd, int inputID, int packs, int opType, int outputID, int width, int height, int logicalChannels = 0)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            cmd.SetComputeIntParam(_cs, "_UnaryOpType", opType);
            cmd.SetComputeIntParam(_cs, "_UnaryChannels", logicalChannels);
        ...
        public void PointwiseBuf(ComputeBuffer input, int total, PointwiseType type, float a, float b, ComputeBuffer output, float c = 0f)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            if (total < 0) throw new ArgumentOutOfRangeException(nameof(total));
        ...
        public void PReluBuf(ComputeBuffer input, AexisTensorBuffer view, ComputeBuffer slope, int slopeCount, ComputeBuffer output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (view == null) throw new ArgumentNullException(nameof(view));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void QuantizeBuf(ComputeBuffer input, AexisTensorBuffer view, ComputeBuffer scale, int scaleDataSize, ComputeBuffer output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (view == null) throw new ArgumentNullException(nameof(view));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void DequantizeBuf(ComputeBuffer input, AexisTensorBuffer view, ComputeBuffer scale, int scaleDataSize, ComputeBuffer bias, int biasDataSize, ComputeBuffer output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (view == null) throw new ArgumentNullException(nameof(view));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void CastPack4(RenderTexture input, AexisGraphSession.BufferShape shape, int typeFrom, int typeTo, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void CastPack4(CommandBuffer cmd, ComputeTexture input, AexisGraphSession.BufferShape shape, int typeFrom, int typeTo, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void QuantizePack4(RenderTexture input, AexisGraphSession.BufferShape shape, ComputeBuffer scale, int scaleDataSize, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
        ...
        public void QuantizePack4(CommandBuffer cmd, ComputeTexture input, AexisGraphSession.BufferShape shape, ComputeBuffer scale, int scaleDataSize, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (scale == null) throw new ArgumentNullException(nameof(scale));
        ...
        public void DequantizePack4(RenderTexture input, AexisGraphSession.BufferShape shape, ComputeBuffer scale, int scaleDataSize, ComputeBuffer bias, int biasDataSize, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (scale == null) throw new ArgumentNullException(nameof(scale));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void DequantizePack4(CommandBuffer cmd, ComputeTexture input, AexisGraphSession.BufferShape shape, ComputeBuffer scale, int scaleDataSize, ComputeBuffer bias, int biasDataSize, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (scale == null) throw new ArgumentNullException(nameof(scale));
        ...
        public void RmsNormPack4(RenderTexture input, AexisGraphSession.BufferShape shape, ComputeBuffer gamma, int affineSize, bool affine, float eps, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void RmsNormPack4(CommandBuffer cmd, ComputeTexture input, AexisGraphSession.BufferShape shape, ComputeBuffer gamma, int affineSize, bool affine, float eps, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void RmsNormPack4LinearMat(RenderTexture input, AexisGraphSession.BufferShape shape, ComputeBuffer gamma, int affineSize, bool affine, float eps, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            if (shape.dims != 1 && shape.dims != 2)
                throw new InvalidOperationException("RmsNormPack4LinearMat requires a one- or two-dimensional logical tensor.");
            ...
            _cs.SetInt("_RmsNormAffine", affine ? 1 : 0);
            _cs.SetFloat("_RmsNormEps", eps);
            _cs.SetBuffer(_kRmsNormPack4LinearMat, "_RmsNormGamma", gamma ?? fallback);
            _cs.SetTexture(_kRmsNormPack4LinearMat, "_TexIn0Arr", input);
            _cs.SetTexture(_kRmsNormPack4LinearMat, "_TexOut0Arr", output);
            Dispatch3D(_kRmsNormPack4LinearMat, output.width, output.height, 1, 8, 8);
        }

        public void RmsNormPack4LinearMat(CommandBuffer cmd, ComputeTexture input, AexisGraphSession.BufferShape shape, ComputeBuffer gamma, int affineSize, bool affine, float eps, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ...
            cmd.SetComputeIntParam(_cs, "_RmsNormAffine", affine ? 1 : 0);
            cmd.SetComputeFloatParam(_cs, "_RmsNormEps", eps);
            cmd.SetComputeBufferParam(_cs, _kRmsNormPack4LinearMat, "_RmsNormGamma", gamma ?? fallback);
            cmd.SetComputeTextureParam(_cs, _kRmsNormPack4LinearMat, "_TexIn0Arr", input.nameID);
            cmd.SetComputeTextureParam(_cs, _kRmsNormPack4LinearMat, "_TexOut0Arr", output.nameID);
            Dispatch3D(cmd, _kRmsNormPack4LinearMat, output.width, output.height, 1, 8, 8);
        }

        private void SetQuantShapeParams(AexisGraphSession.BufferShape shape)
        {
        ...
        private void SetQuantShapeParams(CommandBuffer cmd, AexisGraphSession.BufferShape shape)
        {
        ...
        private void SetNormShapeParams(AexisGraphSession.BufferShape shape)
        {
        ...
        private void SetNormShapeParams(CommandBuffer cmd, AexisGraphSession.BufferShape shape)
        {
        ...
        private void SetRmsNormShapeParams(AexisGraphSession.BufferShape shape)
        {
        ...
        private void SetRmsNormShapeParams(CommandBuffer cmd, AexisGraphSession.BufferShape shape)
        {
        ...
        private void SetRotaryCacheShapeParams(AexisGraphSession.BufferShape cosShape, AexisGraphSession.BufferShape sinShape)
        {
        ...
        private void SetRotaryCacheShapeParams(CommandBuffer cmd, AexisGraphSession.BufferShape cosShape, AexisGraphSession.BufferShape sinShape)
        {
            ...
            RenderTexture output)
        {
            ...
            _cs.SetInt("_UnfoldPadTop", padTop);
            _cs.SetFloat("_UnfoldPadValue", padValue);
            _cs.SetTexture(_kExtractPatchesPack4, "_TexIn0Arr", input);
            _cs.SetTexture(_kExtractPatchesPack4, "_TexOut0Arr", output);
            Dispatch3D(_kExtractPatchesPack4, output.width, output.height, ResolveRenderTextureDispatchDepth(output, output.volumeDepth), 8, 8);
        }
            ...
            ComputeTexture output)
        {
            ...
            cmd.SetComputeIntParam(_cs, "_UnfoldPadTop", padTop);
            cmd.SetComputeFloatParam(_cs, "_UnfoldPadValue", padValue);
            cmd.SetComputeTextureParam(_cs, _kExtractPatchesPack4, "_TexIn0Arr", input.nameID);
            cmd.SetComputeTextureParam(_cs, _kExtractPatchesPack4, "_TexOut0Arr", output.nameID);
            Dispatch3D(cmd, _kExtractPatchesPack4, output.width, output.height, ResolveComputeTextureDispatchDepth(output, output.depth), 8, 8);
        }

        public void ExtractPatchesFoldDPack4(
            RenderTexture input,
            int inW,
            int inH,
            int inD,
            ...
            RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            if (inW <= 0 || inH <= 0 || inD <= 0 || inC <= 0) throw new ArgumentOutOfRangeException(nameof(inW));
            if (outW <= 0 || outH <= 0) throw new ArgumentOutOfRangeException(nameof(outW));

            _cs.SetInt("_UnfoldInW", inW);
            _cs.SetInt("_UnfoldInH", inH);
            _cs.SetInt("_UnfoldInD", inD);
            _cs.SetInt("_UnfoldInC", inC);
            _cs.SetInt("_UnfoldOutW", outW);
            _cs.SetInt("_UnfoldOutH", outH);
            _cs.SetInt("_UnfoldKernelW", kernelW);
            ...
            _cs.SetInt("_UnfoldPadTop", padTop);
            _cs.SetFloat("_UnfoldPadValue", padValue);
            _cs.SetTexture(_kExtractPatchesFoldDPack4, "_TexIn0Arr", input);
            _cs.SetTexture(_kExtractPatchesFoldDPack4, "_TexOut0Arr", output);
            Dispatch3D(_kExtractPatchesFoldDPack4, output.width, output.height, ResolveRenderTextureDispatchDepth(output, output.volumeDepth), 8, 8);
        }
            ...
            ComputeTexture output)
        {
            ...
            cmd.SetComputeIntParam(_cs, "_UnfoldInW", inW);
            cmd.SetComputeIntParam(_cs, "_UnfoldInH", inH);
            cmd.SetComputeIntParam(_cs, "_UnfoldInD", inD);
            cmd.SetComputeIntParam(_cs, "_UnfoldInC", inC);
            cmd.SetComputeIntParam(_cs, "_UnfoldOutW", outW);
            cmd.SetComputeIntParam(_cs, "_UnfoldOutH", outH);
            cmd.SetComputeIntParam(_cs, "_UnfoldKernelW", kernelW);
            ...
            cmd.SetComputeIntParam(_cs, "_UnfoldPadTop", padTop);
            cmd.SetComputeFloatParam(_cs, "_UnfoldPadValue", padValue);
            cmd.SetComputeTextureParam(_cs, _kExtractPatchesFoldDPack4, "_TexIn0Arr", input.nameID);
            cmd.SetComputeTextureParam(_cs, _kExtractPatchesFoldDPack4, "_TexOut0Arr", output.nameID);
            Dispatch3D(cmd, _kExtractPatchesFoldDPack4, output.width, output.height, ResolveComputeTextureDispatchDepth(output, output.depth), 8, 8);
        }
        ...
        public void Pack4SpatialToPack4Linear(RenderTexture input, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            if (input.dimension != TextureDimension.Tex2DArray || output.dimension != TextureDimension.Tex2DArray)
                throw new ArgumentException("Pack4 spatial-to-linear requires Texture2DArray input and output.");
            if (output.width > input.volumeDepth || output.height > input.width * input.height || output.volumeDepth != 1)
                throw new ArgumentException("Pack4 spatial-to-linear texture shape mismatch.");
            _cs.SetTexture(_kPack4SpatialToPack4Linear, "_TexIn0Arr", input);
            _cs.SetTexture(_kPack4SpatialToPack4Linear, "_TexOut0Arr", output);
            Dispatch3D(_kPack4SpatialToPack4Linear, output.width, output.height, 1, 8, 8);
        }

        public void Pack4SpatialToPack4Linear(CommandBuffer cmd, ComputeTexture input, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            if (input.dimension != TextureDimension.Tex2DArray || output.dimension != TextureDimension.Tex2DArray)
                throw new ArgumentException("Pack4 spatial-to-linear requires Texture2DArray input and output.");
            if (output.width > input.depth || output.height > input.width * input.height || output.depth != 1)
                throw new ArgumentException("Pack4 spatial-to-linear texture shape mismatch.");
            cmd.SetComputeTextureParam(_cs, _kPack4SpatialToPack4Linear, "_TexIn0Arr", input.nameID);
            cmd.SetComputeTextureParam(_cs, _kPack4SpatialToPack4Linear, "_TexOut0Arr", output.nameID);
            Dispatch3D(cmd, _kPack4SpatialToPack4Linear, output.width, output.height, 1, 8, 8);
        }

        public void Pack4ReorderMergeRows(RenderTexture input, RenderTexture output, int gridWidth, int gridHeight, int merge)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            if (gridWidth <= 0 || gridHeight <= 0 || merge <= 0) throw new ArgumentOutOfRangeException(nameof(gridWidth));
            if (gridWidth % merge != 0 || gridHeight % merge != 0)
                throw new ArgumentException("Pack4 merge-row grid must be divisible by merge.");
            if (input.dimension != TextureDimension.Tex2DArray || output.dimension != TextureDimension.Tex2DArray)
                throw new ArgumentException("Pack4 merge-row reorder requires Texture2DArray input and output.");
            if (input.width != output.width || input.height != gridWidth * gridHeight || output.height != input.height
                || input.volumeDepth != output.volumeDepth)
                throw new ArgumentException("Pack4 merge-row reorder texture shape mismatch.");
            _cs.SetInt("_Pack4ReorderGridWidth", gridWidth);
            _cs.SetInt("_Pack4ReorderGridHeight", gridHeight);
            _cs.SetInt("_Pack4ReorderMerge", merge);
            _cs.SetTexture(_kPack4ReorderMergeRows, "_TexIn0Arr", input);
            _cs.SetTexture(_kPack4ReorderMergeRows, "_TexOut0Arr", output);
            Dispatch3D(_kPack4ReorderMergeRows, output.width, output.height, output.volumeDepth, 8, 8);
        }

        public void Pack4ReorderMergeRows(CommandBuffer cmd, ComputeTexture input, ComputeTexture output, int gridWidth, int gridHeight, int merge)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ...
            if (input.width != output.width || input.height != gridWidth * gridHeight || output.height != input.height
                ...
                throw new ArgumentException("Pack4 merge-row reorder texture shape mismatch.");
            cmd.SetComputeIntParam(_cs, "_Pack4ReorderGridWidth", gridWidth);
            cmd.SetComputeIntParam(_cs, "_Pack4ReorderGridHeight", gridHeight);
            cmd.SetComputeIntParam(_cs, "_Pack4ReorderMerge", merge);
            cmd.SetComputeTextureParam(_cs, _kPack4ReorderMergeRows, "_TexIn0Arr", input.nameID);
            cmd.SetComputeTextureParam(_cs, _kPack4ReorderMergeRows, "_TexOut0Arr", output.nameID);
            Dispatch3D(cmd, _kPack4ReorderMergeRows, output.width, output.height, output.depth, 8, 8);
        }

        public void LinearMatReorderMergeRows(RenderTexture input, RenderTexture output, int gridWidth, int gridHeight, int merge)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            if (gridWidth <= 0 || gridHeight <= 0 || merge <= 0) throw new ArgumentOutOfRangeException(nameof(gridWidth));
            if (gridWidth % merge != 0 || gridHeight % merge != 0)
                throw new ArgumentException("LinearMat merge-row grid must be divisible by merge.");
            if (input.dimension != TextureDimension.Tex2D || output.dimension != TextureDimension.Tex2D)
                throw new ArgumentException("LinearMat merge-row reorder requires Texture2D input and output.");
            if (input.width != output.width || input.height != gridWidth * gridHeight || output.height != input.height)
                throw new ArgumentException("LinearMat merge-row reorder texture shape mismatch.");
            _cs.SetInt("_Pack4ReorderGridWidth", gridWidth);
            _cs.SetInt("_Pack4ReorderGridHeight", gridHeight);
            _cs.SetInt("_Pack4ReorderMerge", merge);
            _cs.SetTexture(_kLinearMatReorderMergeRows, "_LinearIn0", input);
            _cs.SetTexture(_kLinearMatReorderMergeRows, "_LinearOut0", output);
            Dispatch3D(_kLinearMatReorderMergeRows, output.width, output.height, 1, 8, 8);
        }

        public void LinearMatReorderMergeRows(CommandBuffer cmd, ComputeTexture input, ComputeTexture output, int gridWidth, int gridHeight, int merge)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ...
            cmd.SetComputeIntParam(_cs, "_Pack4ReorderGridHeight", gridHeight);
            cmd.SetComputeIntParam(_cs, "_Pack4ReorderMerge", merge);
            cmd.SetComputeTextureParam(_cs, _kLinearMatReorderMergeRows, "_LinearIn0", input.nameID);
            cmd.SetComputeTextureParam(_cs, _kLinearMatReorderMergeRows, "_LinearOut0", output.nameID);
            Dispatch3D(cmd, _kLinearMatReorderMergeRows, output.width, output.height, 1, 8, 8);
        }
        ...
        public void Softmax2D(ComputeBuffer input, ComputeBuffer output, int rows, int cols, int mode = 0)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            if (rows <= 0) throw new ArgumentOutOfRangeException(nameof(rows));
        ...
        public void ReductionPack4Width(RenderTexture input, int inW, int inH, int opType, float coeff, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ...
            _cs.SetInt("_ReduceScalar2DInW", inW);
            _cs.SetInt("_ReduceScalar2DInH", inH);
            _cs.SetInt("_ReduceScalar2DAxis", 1);
            _cs.SetInt("_ReduceScalar2DOpType", opType);
            _cs.SetFloat("_ReduceScalar2DCoeff", coeff);
            _cs.SetTexture(_kReductionPack4Width, "_TexIn0Arr", input);
            _cs.SetTexture(_kReductionPack4Width, "_TexOut0Arr", output);
            Dispatch3D(_kReductionPack4Width, output.width, output.height, ResolveRenderTextureDispatchDepth(output, output.volumeDepth), 8, 8);
        }

        public void ReductionPack4Width(CommandBuffer cmd, ComputeTexture input, int inW, int inH, int opType, float coeff, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ...
            cmd.SetComputeIntParam(_cs, "_ReduceScalar2DInW", inW);
            cmd.SetComputeIntParam(_cs, "_ReduceScalar2DInH", inH);
            cmd.SetComputeIntParam(_cs, "_ReduceScalar2DAxis", 1);
            cmd.SetComputeIntParam(_cs, "_ReduceScalar2DOpType", opType);
            cmd.SetComputeFloatParam(_cs, "_ReduceScalar2DCoeff", coeff);
            cmd.SetComputeTextureParam(_cs, _kReductionPack4Width, "_TexIn0Arr", input.nameID);
            cmd.SetComputeTextureParam(_cs, _kReductionPack4Width, "_TexOut0Arr", output.nameID);
            Dispatch3D(cmd, _kReductionPack4Width, output.width, output.height, ResolveComputeTextureDispatchDepth(output, output.depth), 8, 8);
        }

        public void ReductionPack4Channel(RenderTexture input, int inW, int inH, int inC, int opType, float coeff, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            if (inW <= 0) throw new ArgumentOutOfRangeException(nameof(inW));
            ...
            _cs.SetInt("_ReduceScalar2DInW", inW);
            _cs.SetInt("_ReduceScalar2DInH", inH);
            _cs.SetInt("_ReduceScalar2DAxis", 0);
            _cs.SetInt("_ReduceScalar2DOpType", opType);
            _cs.SetFloat("_ReduceScalar2DCoeff", coeff);
            _cs.SetInt("_ReducePack4InC", inC);
            _cs.SetTexture(_kReductionPack4Channel, "_TexIn0Arr", input);
            _cs.SetTexture(_kReductionPack4Channel, "_TexOut0Arr", output);
            Dispatch3D(_kReductionPack4Channel, output.width, output.height, ResolveRenderTextureDispatchDepth(output, output.volumeDepth), 8, 8);
        }

        public void ReductionPack4Channel(CommandBuffer cmd, ComputeTexture input, int inW, int inH, int inC, int opType, float coeff, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ...
            cmd.SetComputeIntParam(_cs, "_ReduceScalar2DInW", inW);
            cmd.SetComputeIntParam(_cs, "_ReduceScalar2DInH", inH);
            cmd.SetComputeIntParam(_cs, "_ReduceScalar2DAxis", 0);
            cmd.SetComputeIntParam(_cs, "_ReduceScalar2DOpType", opType);
            cmd.SetComputeFloatParam(_cs, "_ReduceScalar2DCoeff", coeff);
            cmd.SetComputeIntParam(_cs, "_ReducePack4InC", inC);
            cmd.SetComputeTextureParam(_cs, _kReductionPack4Channel, "_TexIn0Arr", input.nameID);
            cmd.SetComputeTextureParam(_cs, _kReductionPack4Channel, "_TexOut0Arr", output.nameID);
            Dispatch3D(cmd, _kReductionPack4Channel, output.width, output.height, ResolveComputeTextureDispatchDepth(output, output.depth), 8, 8);
        }
        ...
        private static int ResolveTileArrayDepth(AexisGraphSession.BufferShape shape)
        {
        ...
        public void TilePack4(RenderTexture input, AexisGraphSession.BufferShape inShape, AexisGraphSession.BufferShape outShape, Vector4Int repeats, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void TilePack4(CommandBuffer cmd, ComputeTexture input, AexisGraphSession.BufferShape inShape, AexisGraphSession.BufferShape outShape, Vector4Int repeats, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void TileLinearMat(RenderTexture input, AexisGraphSession.BufferShape inShape, AexisGraphSession.BufferShape inStorageShape, AexisGraphSession.BufferShape outShape, AexisGraphSession.BufferShape outStorageShape, Vector4Int repeats, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void TileLinearMat(CommandBuffer cmd, ComputeTexture input, AexisGraphSession.BufferShape inShape, AexisGraphSession.BufferShape inStorageShape, AexisGraphSession.BufferShape outShape, AexisGraphSession.BufferShape outStorageShape, Vector4Int repeats, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void GroupNormPack4Tex(RenderTexture input, int w, int h, int d, int c, int packs, int group, float eps, ComputeBuffer gamma, ComputeBuffer beta, RenderTexture statsA, RenderTexture statsB, RenderTexture output, bool ncnnMvn = false, bool normalizeVariance = true)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ...
            _cs.SetInt("_GnChannelsG", channelsG);
            _cs.SetFloat("_GnEps", eps);
            _cs.SetInt("_GnAffine", ncnnMvn ? 0 : 1);
            _cs.SetInt("_GnMvnMode", ncnnMvn ? (normalizeVariance ? 1 : 2) : 0);
        ...
        public void GroupNormPack4Tex(CommandBuffer cmd, ComputeTexture input, int w, int h, int d, int c, int packs, int group, float eps, ComputeBuffer gamma, ComputeBuffer beta, ComputeTexture statsA, ComputeTexture statsB, ComputeTexture output, bool ncnnMvn = false, bool normalizeVariance = true)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ...
            cmd.SetComputeIntParam(_cs, "_GnAffine", ncnnMvn ? 0 : 1);
            cmd.SetComputeIntParam(_cs, "_GnMvnMode", ncnnMvn ? (normalizeVariance ? 1 : 2) : 0);
        ...
        public void Conv3x3(AexisTensorBuffer input, ComputeBuffer weightsOihw, ComputeBuffer biasO, int outC, int stride, int pad, int activationType, float activationParam, AexisTensorBuffer output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void LeakyReluInplace(AexisTensorBuffer t, float slope)
        {
        ...
        public void AddWeighted(AexisTensorBuffer a, AexisTensorBuffer b, float coeffA, float coeffB, AexisTensorBuffer output)
        {
            if (a == null) throw new ArgumentNullException(nameof(a));
            if (b == null) throw new ArgumentNullException(nameof(b));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void CopyToConcat(AexisTensorBuffer src, AexisTensorBuffer dst, int dstChannelOffset)
        {
            if (src == null) throw new ArgumentNullException(nameof(src));
            if (dst == null) throw new ArgumentNullException(nameof(dst));
        ...
        public void Interp2x(AexisTensorBuffer input, AexisTensorBuffer output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void PointwisePack4(RenderTexture input, int packs, PointwiseType type, float a, float b, RenderTexture output, float c = 0f, int logicalChannels = 0)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            _cs.SetInt("_PointwiseType", (int)type);
            ...
            _cs.SetFloat("_PointwiseB", b);
            _cs.SetFloat("_PointwiseC", c);
            _cs.SetInt("_PointwiseChannels", logicalChannels);
        ...
        public void PointwisePack4(CommandBuffer cmd, ComputeTexture input, int packs, PointwiseType type, float a, float b, ComputeTexture output, float c = 0f, int logicalChannels = 0)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
            ...
            cmd.SetComputeFloatParam(_cs, "_PointwiseC", c);
            cmd.SetComputeIntParam(_cs, "_PointwiseChannels", logicalChannels);
        ...
        public void GatedDeltaRulePack4(
            ...
            RenderTexture key,
            RenderTexture value,
            RenderTexture stateIn,
            RenderTexture output,
            RenderTexture stateOut,
            int heads,
            int keyDim,
            int valueDim,
            int sequenceLength,
        ...
        public void ShortConvPack4(
            ...
            ComputeTexture cacheIn,
            ComputeTexture output,
            ComputeTexture cacheOut,
            int groups,
            int kernelSize,
            int sequenceLength,
            int cacheLength)
        ...
        public void GatedDeltaRulePack4(
            ...
            ComputeTexture key,
            ComputeTexture value,
            ComputeTexture stateIn,
            ComputeTexture output,
            ComputeTexture stateOut,
            int heads,
            int keyDim,
            int valueDim,
            int sequenceLength,
