...
{
    public readonly struct AexisTemporaryRtDescriptor
    {
        public AexisTemporaryRtDescriptor(
    ...
    public static class AexisGpuResourceTracker
    {
        ...
        private sealed class TextureInfo
        {
            ...
            public string owner;
            public string node;
            public AexisGraphSession.BufferShape logicalShape;
            public AexisGraphSession.BufferShape storageShape;
        ...
        public static void RegisterTemporaryTexture(RenderTexture texture, AexisTemporaryRtDescriptor descriptor)
        {
            if (texture == null)
                return;
        ...
        public static void RegisterTemporaryTextureHandle(int handle, AexisTemporaryRtDescriptor descriptor)
        {
            if (handle == 0)
                return;
        ...
        public static long EstimateTemporaryTextureBytes(AexisTemporaryRtDescriptor descriptor)
        {
        ...
        private static void RegisterTextureCore(int id, AexisTemporaryRtDescriptor descriptor, RenderTextureFormat format)
        {
            if (Textures.ContainsKey(id))
                return;
