...
{
    public enum AexisTextureTensorLayoutKind
    {
        LinearMat = 0,
        Pack4Image = 1
    }
    ...
    public sealed class TensorDescriptor
    {
        public TensorDescriptor(
            ...
            AexisTextureTensorLayoutKind layout,
            ...
            AexisTextureTensor nativeTensor)
        {
        ...
        public AexisGraphSession.BufferShape StorageShape { get; }
        public AexisTextureTensorLayoutKind Layout { get; }
        ...
        public AexisTextureTensor NativeTensor { get; }

        public bool IsStorageLayoutCompatibleWith(
            AexisGraphSession.BufferShape targetStorageShape,
            AexisTextureTensorLayoutKind targetLayout,
        ...
        internal static bool ShapeEquals(AexisGraphSession.BufferShape a, AexisGraphSession.BufferShape b)
        {
        ...
        internal static string FormatShape(AexisGraphSession.BufferShape shape)
        {
    ...
    {
        public TensorAliasTransformRequiredException(TensorDescriptor source, AexisGraphSession.BufferShape targetLogicalShape, AexisGraphSession.BufferShape targetStorageShape)
            : base(
        ...
        public AexisGraphSession.BufferShape TargetLogicalShape { get; }
        public AexisGraphSession.BufferShape TargetStorageShape { get; }
    }

    public abstract class AexisTextureTensor
    {
        protected AexisTextureTensor(
        ...
        public AexisTextureTensorLayoutKind LayoutKind { get; }
        public AexisGraphSession.BufferShape LogicalShape { get; }
        public AexisGraphSession.BufferShape StorageShape { get; }
    ...
    public sealed class AexisTextureMat : AexisTextureTensor
    {
        ...
        public AexisTextureMat(
            RenderTexture texture,
            AexisGraphSession.BufferShape logicalShape,
            AexisGraphSession.BufferShape storageShape,
            int packs = 1)
            : base(AexisTextureTensorLayoutKind.LinearMat, logicalShape, storageShape)
        {
            if (texture == null)
    ...
    public sealed class AexisTextureImageMat : AexisTextureTensor
    {
        private readonly RenderTexture _renderTexture;
        private readonly ComputeTexture _computeTexture;
        private readonly int _width;
        ...
        public AexisTextureImageMat(
            RenderTexture texture,
            AexisGraphSession.BufferShape logicalShape,
            AexisGraphSession.BufferShape storageShape,
            int packs,
            int depth)
            : base(AexisTextureTensorLayoutKind.Pack4Image, logicalShape, storageShape)
        {
            if (texture == null)
                throw new ArgumentNullException(nameof(texture));
