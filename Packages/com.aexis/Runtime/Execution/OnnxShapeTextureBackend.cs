...
namespace Aexis.Execution
{
    ...
    {
        private const string ResourceName = "Aexis/Onnx/AexisOnnx";
        private readonly ComputeShader shader;

        public OnnxShapeTextureBackend()
        {
            shader = Resources.Load<ComputeShader>(ResourceName);
            if (shader == null) throw new InvalidOperationException("Aexis ONNX shape compute shader is required for texture-native ONNX execution.");
        }
