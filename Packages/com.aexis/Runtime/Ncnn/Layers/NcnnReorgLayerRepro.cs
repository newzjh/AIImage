...
#pragma warning restore CS0618
        ...
        public override void ExecuteCommandBuffer(NcnnGraphSession owner, NcnnParamModel.Layer layer, NcnnLayerCommandBufferContext context)
        {
            ...
            if (stride != 2 || mode != 0)
            {
                ...
                var srcShapeFallback = NcnnGraphSession.GetCmdShape(shapesFallback, blobsFallback, layer.bottomNames[0]);
                var outShapeFallback = new NcnnGraphSession.BufferShape(
                    3,
            ...
            if (shapes != null)
                shapes[layer.topNames[0]] = new NcnnGraphSession.BufferShape(3, srcShape.w / 2, srcShape.h / 2, 1, srcShape.c * 4);
