...
{
    public sealed class NcnnPooling3DLayerRepro : NcnnBaseLayerRepro
    {
        public NcnnPooling3DLayerRepro()
            : base(NcnnLayerTypes.Pooling3D, supportsBufferPath: true, supportsCommandBufferPath: true)
        {
        }
...
#pragma warning restore CS0618
        ...
        public override void ExecuteRenderTexturePath(NcnnGraphSession owner, NcnnParamModel.Layer layer, NcnnLayerBufferContext context)
        {
            ...
            var outRt = owner.RentTempArray(outW, outH, outSlices, NcnnGraphSession.ResolveTensorTextureFormat(4));
            owner.Ops.PoolingPack4Cdhw(
                ...
                srcShape.c,
                outRt);
            NcnnGraphSession.SetTextureBlob(textureBlobs, textureShapes, layer.topNames[0], outRt, new NcnnGraphSession.BufferShape(4, outW, outH, outD, srcShape.c), new NcnnGraphSession.BufferShape(4, outW, outH, outD, srcShape.c));
            owner.Consume(textureBlobs, bufferBlobs, bufferRefs, bufferViews, remaining, layer.bottomNames, pinnedNames);
        }
        ...
        public override void ExecuteCommandBuffer(NcnnGraphSession owner, NcnnParamModel.Layer layer, NcnnLayerCommandBufferContext context)
        {
            ...
            var outShape = new NcnnGraphSession.BufferShape(4, outW, outH, outD, srcShape.c);
            var outRt = owner.RentTempArray(cmd, outW, outH, outD * src.packs, NcnnGraphSession.ResolveTensorTextureFormat(4));
            owner.Ops.PoolingPack4Cdhw(
                cmd,
                src.texture,
                srcShape.w,
        ...
        private static void ResolveOutputShape(
            NcnnGraphSession.BufferShape src,
            bool globalPooling,
            bool adaptivePooling,
            int kernelW,
            int kernelH,
