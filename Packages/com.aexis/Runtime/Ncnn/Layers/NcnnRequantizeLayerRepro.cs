...
namespace Aexis.Ncnn
{
    ...
    public sealed class NcnnRequantizeLayerRepro : NcnnBaseLayerRepro
    {
        ...
        public override NcnnGraphSession.LayerLoadMetrics LoadLayer(NcnnGraphSession owner, NcnnParamModel.Layer layer, NcnnBinReader br)
        {
            ...
            var rp = new NcnnGraphSession.RequantizePack
            {
            ...
            var activationParams = NcnnGraphSession.ParseActivationParams(layer);
            ...
            phaseSw.Restart();
            rp.scaleIn = NcnnGraphSession.NewBuffer(rp.scaleInCpu);
            rp.scaleOut = NcnnGraphSession.NewBuffer(rp.scaleOutCpu);
            if (rp.biasCpu != null)
                rp.bias = NcnnGraphSession.NewBuffer(rp.biasCpu);
            phaseSw.Stop();
...
#pragma warning restore CS0618
        ...
        public override void ExecuteComputeBufferPath(NcnnGraphSession owner, NcnnParamModel.Layer layer, NcnnLayerBufferContext context)
        {
            ...
            if (!owner._extraPacks.TryGetValue(layer.name, out var packObj) || packObj is not NcnnGraphSession.RequantizePack rp)
