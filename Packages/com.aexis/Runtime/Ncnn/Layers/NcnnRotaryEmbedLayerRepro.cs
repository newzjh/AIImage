...
namespace Aexis.Ncnn
{
    ...
    public sealed class NcnnRotaryEmbedLayerRepro : NcnnBaseLayerRepro
    {
        ...
        {
            owner._extraPacks[layer.name] = new NcnnGraphSession.RotaryEmbedPack
            {
...
#pragma warning restore CS0618
        ...
        public override void ExecuteComputeBufferPath(NcnnGraphSession owner, NcnnParamModel.Layer layer, NcnnLayerBufferContext context)
        {
            ...
            if (!owner._extraPacks.TryGetValue(layer.name, out var packObj) || packObj is not NcnnGraphSession.RotaryEmbedPack rp)
            ...
            var cosView = NcnnGraphSession.TryGetBufferView(layer.bottomNames[1], bufferBlobs, bufferViews);
            var sinView = NcnnGraphSession.TryGetBufferView(layer.bottomNames[2], bufferBlobs, bufferViews);
        ...
        public override void ExecuteRenderTexturePath(NcnnGraphSession owner, NcnnParamModel.Layer layer, NcnnLayerBufferContext context)
        {
            ...
            var cosShape = NcnnGraphSession.GetTextureShape(textureShapes, cos, layer.bottomNames[1]);
            var sinShape = NcnnGraphSession.GetTextureShape(textureShapes, sin, layer.bottomNames[2]);
            ...
            try
            {
                ...
                NcnnGraphSession.SetTextureBlob(textureBlobs, textureShapes, layer.topNames[0], output, srcShape, storageShape);
                output = null;
            }
            finally
            {
        ...
        public override void ExecuteCommandBuffer(NcnnGraphSession owner, NcnnParamModel.Layer layer, NcnnLayerCommandBufferContext context)
        {
            ...
            var cos = NcnnGraphSession.GetCmdTensor(blobs, layer.bottomNames[1]);
            var cosShape = NcnnGraphSession.GetCmdShape(shapes, blobs, layer.bottomNames[1]);
            var sin = NcnnGraphSession.GetCmdTensor(blobs, layer.bottomNames[2]);
            var sinShape = NcnnGraphSession.GetCmdShape(shapes, blobs, layer.bottomNames[2]);
            ...
            try
            {
                ...
                blobs[layer.topNames[0]] = NcnnGraphSession.CreateCmdTensorRef(output, srcShape, storageShape, owned: true);
                output = null;
                if (shapes != null)
        ...
        private static NcnnGraphSession.TensorRef GetRenderTextureBottom(NcnnParamModel.Layer layer, NcnnLayerBufferContext context, int index, string role)
        {
        ...
        private static void ValidateRenderTextureInputs(
            ...
            NcnnGraphSession.TensorRef cos,
            NcnnGraphSession.BufferShape cosShape,
            NcnnGraphSession.TensorRef sin,
        ...
        private static void ValidateCommandBufferInputs(
            ...
            NcnnGraphSession.BufferShape srcShape,
            NcnnGraphSession.CmdTensorRef cos,
            NcnnGraphSession.BufferShape cosShape,
            NcnnGraphSession.CmdTensorRef sin,
            NcnnGraphSession.BufferShape sinShape)
        {
        ...
        private static void ValidatePack4TextureArray(NcnnParamModel.Layer layer, string role, NcnnGraphSession.TensorRef tensor, NcnnGraphSession.BufferShape logicalShape)
        {
            ...
            if (NcnnGraphSession.IsStrictLinearMatTexture(tensor) || tensor.texture.dimension != TextureDimension.Tex2DArray)
        ...
        private static void ValidatePack4TextureArray(NcnnParamModel.Layer layer, string role, NcnnGraphSession.CmdTensorRef tensor, NcnnGraphSession.BufferShape logicalShape)
        {
            if (tensor == null || tensor.texture == null)
        ...
        private static void ValidateCacheShape(NcnnParamModel.Layer layer, NcnnGraphSession.BufferShape srcShape, NcnnGraphSession.BufferShape cosShape, NcnnGraphSession.BufferShape sinShape)
        {
        ...
        private static long GetElementCount(NcnnGraphSession.BufferShape shape)
        {
        ...
        private static string FormatShape(NcnnGraphSession.BufferShape shape)
        {
