...
namespace Aexis.Ncnn
{
    ...
    public sealed class NcnnDequantizeLayerRepro : NcnnBaseLayerRepro
    {
        ...
        public override NcnnGraphSession.LayerLoadMetrics LoadLayer(NcnnGraphSession owner, NcnnParamModel.Layer layer, NcnnBinReader br)
        {
            ...
            var dp = new NcnnGraphSession.DequantizePack
            {
            ...
            phaseSw.Restart();
            dp.scale = NcnnGraphSession.NewBuffer(dp.scaleCpu);
            if (dp.biasCpu != null)
                dp.bias = NcnnGraphSession.NewBuffer(dp.biasCpu);
            phaseSw.Stop();
...
#pragma warning restore CS0618
        ...
        public override void ExecuteComputeBufferPath(NcnnGraphSession owner, NcnnParamModel.Layer layer, NcnnLayerBufferContext context)
        {
            ...
            if (!owner._extraPacks.TryGetValue(layer.name, out var packObj) || packObj is not NcnnGraphSession.DequantizePack dp)
