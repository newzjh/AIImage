    ...
    public sealed class NcnnInstanceNormLayerRepro : NcnnBaseLayerRepro
    {
        ...
        public override NcnnGraphSession.LayerLoadMetrics LoadLayer(NcnnGraphSession owner, NcnnParamModel.Layer layer, NcnnBinReader br)
        {
            ...
            if (gp.affine)
            {
                ...
                phaseSw.Restart();
                gp.gamma = NcnnGraphSession.NewBuffer(gamma);
                gp.beta = NcnnGraphSession.NewBuffer(beta);
                phaseSw.Stop();
        ...
        {
            if (!owner._extraPacks.TryGetValue(layer.name, out var packObj) || packObj is not NcnnGraphSession.GroupNormPack gp)
        ...
        public override void ExecuteCommandBuffer(NcnnGraphSession owner, NcnnParamModel.Layer layer, NcnnLayerCommandBufferContext context)
        {
            ...
            else
            {
                ...
                NcnnGraphSession.ResolveCmdTextureLayout(srcShape, out var width, out var height, out var packs);
