...
namespace Aexis.Ncnn
{
    ...
    public sealed class NcnnPReLULayerRepro : NcnnBaseLayerRepro
    {
        ...
        public override NcnnGraphSession.LayerLoadMetrics LoadLayer(NcnnGraphSession owner, NcnnParamModel.Layer layer, NcnnBinReader br)
        {
            ...
            var pp = new NcnnGraphSession.PReluPack
            {
            ...
            phaseSw.Restart();
            pp.slope = NcnnGraphSession.NewBuffer(pp.slopeCpu);
            phaseSw.Stop();
        ...
        {
            if (!owner._extraPacks.TryGetValue(layer.name, out var packObj) || packObj is not NcnnGraphSession.PReluPack pp)
