...
#pragma warning restore CS0618
        ...
        public override void ExecuteRenderTexturePath(NcnnGraphSession owner, NcnnParamModel.Layer layer, NcnnLayerBufferContext context)
        {
            ...
            try
            {
                ...
                var outShape = new NcnnGraphSession.BufferShape(3, idx.sourceWidth, idx.sourceHeight, 1, srcShape.c);
                ...
                textureBlobs[layer.topNames[0]] = NcnnGraphSession.CreateTextureRef(outRt, outShape, outShape, owned: true);
        ...
        public override void ExecuteCommandBuffer(NcnnGraphSession owner, NcnnParamModel.Layer layer, NcnnLayerCommandBufferContext context)
        {
            ...
            var idx = NcnnGraphSession.GetCmdTensor(blobs, layer.bottomNames[1]);
            var idxShape = NcnnGraphSession.GetCmdShape(shapes, blobs, layer.bottomNames[1]);
            var kernelW = idx.kernelW > 0 ? idx.kernelW : layer.GetInt(1, 0);
            var kernelH = idx.kernelH > 0 ? idx.kernelH : layer.GetInt(11, kernelW);
            var strideW = idx.strideW > 0 ? idx.strideW : layer.GetInt(2, 1);
            var strideH = idx.strideH > 0 ? idx.strideH : layer.GetInt(12, strideW);
