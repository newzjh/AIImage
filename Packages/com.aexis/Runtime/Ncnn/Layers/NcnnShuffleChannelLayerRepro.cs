...
#pragma warning restore CS0618
        ...
        private static bool CanUsePack4Path(NcnnGraphSession.TensorRef srcTex, NcnnGraphSession.BufferShape srcShape, int group, bool reverse, out int actualGroup)
        {
            actualGroup = 0;
        ...
        private static bool CanUsePack4Path(NcnnGraphSession.CmdTensorRef src, NcnnGraphSession.BufferShape srcShape, int group, bool reverse, out int actualGroup)
        {
            actualGroup = 0;
        ...
        private static bool CanUsePack4Path(int width, int height, int packs, NcnnGraphSession.BufferShape srcShape, int group, bool reverse, out int actualGroup)
        {
            actualGroup = 0;
            if (srcShape.dims != 3)
                return false;
