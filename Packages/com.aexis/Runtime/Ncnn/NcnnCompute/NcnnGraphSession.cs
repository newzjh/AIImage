...
namespace Aexis.Ncnn
{
    ...
    public partial class NcnnGraphSession : IInferenceSession
    {
        ...
        public readonly struct NcnnTextureTensorContract
        {
            public NcnnTextureTensorContract(IInferenceTensor tensor)
            {
            ...
            public NcnnTextureTensor Tensor => Descriptor != null ? Descriptor.NativeTensor : null;
            ...
            public NcnnTextureTensorLayoutKind LayoutKind => Descriptor != null ? Descriptor.Layout : default;
            ...
            public bool IsLinearMat => LayoutKind == NcnnTextureTensorLayoutKind.LinearMat;
            public bool IsPack4Image => LayoutKind == NcnnTextureTensorLayoutKind.Pack4Image;
        }
        ...
        public sealed class TensorRef : IInferenceTensor
        {
            ...
            public NcnnTextureTensor repoTensor;
            public NcnnTextureTensorLayoutKind layoutKind;
        ...
        public sealed class ConvPack : IDisposable
        {
            ...
            public void Dispose()
            {
                try { NcnnGpuResourceTracker.ReleaseBuffer(packedWeight4, "NcnnGraphSession.ConvPack.Dispose"); packedWeight4?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(packedWeight4Fp16, "NcnnGraphSession.ConvPack.Dispose"); packedWeight4Fp16?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(packedBias4, "NcnnGraphSession.ConvPack.Dispose"); packedBias4?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(packedWeightTm23, "NcnnGraphSession.ConvPack.Dispose"); packedWeightTm23?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(packedDepthWiseWeight4, "NcnnGraphSession.ConvPack.Dispose"); packedDepthWiseWeight4?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(packedDepthWiseWeight4Fp16, "NcnnGraphSession.ConvPack.Dispose"); packedDepthWiseWeight4Fp16?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(rawWeight, "NcnnGraphSession.ConvPack.Dispose"); rawWeight?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(rawWeightInt8Packed, "NcnnGraphSession.ConvPack.Dispose"); rawWeightInt8Packed?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(rawWeightInt8Scales, "NcnnGraphSession.ConvPack.Dispose"); rawWeightInt8Scales?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(rawWeightInt4Packed, "NcnnGraphSession.ConvPack.Dispose"); rawWeightInt4Packed?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(rawWeightInt4Scales, "NcnnGraphSession.ConvPack.Dispose"); rawWeightInt4Scales?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(rawBias, "NcnnGraphSession.ConvPack.Dispose"); rawBias?.Dispose(); } catch { }
            }
        }
        ...
        public sealed class InnerProductPack : IDisposable
        {
            ...
            public void Dispose()
            {
                try { NcnnGpuResourceTracker.ReleaseBuffer(w, "NcnnGraphSession.InnerProductPack.Dispose"); w?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(wFp16, "NcnnGraphSession.InnerProductPack.Dispose"); wFp16?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(wInt8Packed, "NcnnGraphSession.InnerProductPack.Dispose"); wInt8Packed?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(wInt8Scales, "NcnnGraphSession.InnerProductPack.Dispose"); wInt8Scales?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(wInt4Packed, "NcnnGraphSession.InnerProductPack.Dispose"); wInt4Packed?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(wInt4Scales, "NcnnGraphSession.InnerProductPack.Dispose"); wInt4Scales?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(b, "NcnnGraphSession.InnerProductPack.Dispose"); b?.Dispose(); } catch { }
            }
        }
        ...
        public sealed class DeconvPack : IDisposable
        {
            ...
            public void Dispose()
            {
                try { NcnnGpuResourceTracker.ReleaseBuffer(packedWeight4, "NcnnGraphSession.DeconvPack.Dispose"); packedWeight4?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(packedWeight4Fp16, "NcnnGraphSession.DeconvPack.Dispose"); packedWeight4Fp16?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(packedBias4, "NcnnGraphSession.DeconvPack.Dispose"); packedBias4?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(rawWeight, "NcnnGraphSession.DeconvPack.Dispose"); rawWeight?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(rawBias, "NcnnGraphSession.DeconvPack.Dispose"); rawBias?.Dispose(); } catch { }
            }
        }
        ...
        public sealed class GemmPack : IDisposable
        {
            ...
            public void Dispose()
            {
                try { if (ownsBData) { NcnnGpuResourceTracker.ReleaseBuffer(bData, "NcnnGraphSession.GemmPack.Dispose"); bData?.Dispose(); } } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(bDataFp16, "NcnnGraphSession.GemmPack.Dispose"); bDataFp16?.Dispose(); } catch { }
                try { if (ownsBDataInt8) { NcnnGpuResourceTracker.ReleaseBuffer(bDataInt8Packed, "NcnnGraphSession.GemmPack.Dispose"); bDataInt8Packed?.Dispose(); } } catch { }
                try { if (ownsBDataInt8) { NcnnGpuResourceTracker.ReleaseBuffer(bDataInt8Scales, "NcnnGraphSession.GemmPack.Dispose"); bDataInt8Scales?.Dispose(); } } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(bDataInt4Packed, "NcnnGraphSession.GemmPack.Dispose"); bDataInt4Packed?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(bDataInt4Scales, "NcnnGraphSession.GemmPack.Dispose"); bDataInt4Scales?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(cData, "NcnnGraphSession.GemmPack.Dispose"); cData?.Dispose(); } catch { }
            }
        }
        ...
        public sealed class MemoryDataPack : IDisposable
        {
            ...
            public void Dispose()
            {
                try { NcnnGpuResourceTracker.ReleaseBuffer(data, "NcnnGraphSession.MemoryDataPack.Dispose"); data?.Dispose(); } catch { }
                try { if (channelVectorTexture != null) UnityEngine.Object.DestroyImmediate(channelVectorTexture); } catch { }
                try
                {
                    if (pack4Rt != null)
                    {
                        NcnnGpuResourceTracker.ReleaseTexture(pack4Rt, "NcnnGraphSession.MemoryDataPack.Dispose");
                        pack4Rt.Release();
                ...
                try
                {
                    if (linearMatRt != null)
                    {
                        NcnnGpuResourceTracker.ReleaseTexture(linearMatRt, "NcnnGraphSession.MemoryDataPack.Dispose");
                        linearMatRt.Release();
        ...
        public sealed class EmbedPack : IDisposable
        {
            ...
            public void Dispose()
            {
                try { if (ownsW) { NcnnGpuResourceTracker.ReleaseBuffer(w, "NcnnGraphSession.EmbedPack.Dispose"); w?.Dispose(); } } catch { }
                try { if (ownsWInt8) { NcnnGpuResourceTracker.ReleaseBuffer(wInt8Packed, "NcnnGraphSession.EmbedPack.Dispose.Int8Packed"); wInt8Packed?.Dispose(); } } catch { }
                try { if (ownsWInt8) { NcnnGpuResourceTracker.ReleaseBuffer(wInt8Scales, "NcnnGraphSession.EmbedPack.Dispose.Int8Scales"); wInt8Scales?.Dispose(); } } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(b, "NcnnGraphSession.EmbedPack.Dispose"); b?.Dispose(); } catch { }
            }
        }
        ...
        public sealed class LayerNormPack : IDisposable
        {
            ...
            public void Dispose()
            {
                try { NcnnGpuResourceTracker.ReleaseBuffer(gamma, "NcnnGraphSession.LayerNormPack.Dispose"); gamma?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(beta, "NcnnGraphSession.LayerNormPack.Dispose"); beta?.Dispose(); } catch { }
            }
        }
        ...
        public sealed class GroupNormPack : IDisposable
        {
            ...
            public void Dispose()
            {
                try { NcnnGpuResourceTracker.ReleaseBuffer(gamma, "NcnnGraphSession.GroupNormPack.Dispose"); gamma?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(beta, "NcnnGraphSession.GroupNormPack.Dispose"); beta?.Dispose(); } catch { }
            }
        }
        ...
        public sealed class BatchNormPack : IDisposable
        {
            ...
            public void Dispose()
            {
                try { NcnnGpuResourceTracker.ReleaseBuffer(biasA, "NcnnGraphSession.BatchNormPack.Dispose"); biasA?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(scaleB, "NcnnGraphSession.BatchNormPack.Dispose"); scaleB?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(biasA4, "NcnnGraphSession.BatchNormPack.Dispose"); biasA4?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(scaleB4, "NcnnGraphSession.BatchNormPack.Dispose"); scaleB4?.Dispose(); } catch { }
            }
        }
        ...
        public sealed class MultiHeadAttentionPack : IDisposable
        {
            ...
            public void Dispose()
            {
                try { NcnnGpuResourceTracker.ReleaseBuffer(qW, "NcnnGraphSession.MultiHeadAttentionPack.Dispose"); qW?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(qB, "NcnnGraphSession.MultiHeadAttentionPack.Dispose"); qB?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(kW, "NcnnGraphSession.MultiHeadAttentionPack.Dispose"); kW?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(kB, "NcnnGraphSession.MultiHeadAttentionPack.Dispose"); kB?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(vW, "NcnnGraphSession.MultiHeadAttentionPack.Dispose"); vW?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(vB, "NcnnGraphSession.MultiHeadAttentionPack.Dispose"); vB?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(oW, "NcnnGraphSession.MultiHeadAttentionPack.Dispose"); oW?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(oB, "NcnnGraphSession.MultiHeadAttentionPack.Dispose"); oB?.Dispose(); } catch { }
            }
        }
        ...
        public sealed class PriorBoxPack : IDisposable
        {
            ...
            public void Dispose()
            {
                try { NcnnGpuResourceTracker.ReleaseBuffer(minSizeBuffer, "NcnnGraphSession.PriorBoxPack.Dispose"); minSizeBuffer?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(maxSizeBuffer, "NcnnGraphSession.PriorBoxPack.Dispose"); maxSizeBuffer?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(aspectRatioBuffer, "NcnnGraphSession.PriorBoxPack.Dispose"); aspectRatioBuffer?.Dispose(); } catch { }
                try { NcnnGpuResourceTracker.ReleaseBuffer(varianceBuffer, "NcnnGraphSession.PriorBoxPack.Dispose"); varianceBuffer?.Dispose(); } catch { }
            }
        }
        ...
        public sealed class InferResult : IDisposable
        {
                ...
                NcnnTextureTensorLayoutKind layoutKind)
            {
                ...
                try
                {
                    ...
                    if (layoutKind == NcnnTextureTensorLayoutKind.LinearMat || texture.dimension == TextureDimension.Tex2D)
                    {
        ...
        public NcnnGraphSession(NcnnOps ops)
        {
        ...
        private LayerLoadMetrics LoadLayer(NcnnParamModel.Layer layer, NcnnBinReader br)
        {
                ...
                || layer.type == NcnnLayerTypes.ConvolutionDepthWise)
            {
                ...
                if (needGeneralTexturePack && !UsesQuantizedWeightsForLayer(layer))
                {
                    ...
                    NcnnGpuResourceTracker.RegisterBuffer(pack.packedWeight4, w4.Length, sizeof(float) * 4, "NcnnGraphSession.ConvPackedWeight4:" + layer.name);
                    pack.packedBias4 = new ComputeBuffer(b4.Length, sizeof(float) * 4, ComputeBufferType.Structured);
                    NcnnGpuResourceTracker.RegisterBuffer(pack.packedBias4, b4.Length, sizeof(float) * 4, "NcnnGraphSession.ConvPackedBias4:" + layer.name);
                    pack.packedWeight4.SetData(w4);
                    pack.packedBias4.SetData(b4);
                    if (UsesFp16WeightStorage)
                        pack.packedWeight4Fp16 = NewFp16Vector4Buffer(w4, "NcnnGraphSession.ConvPackedWeight4Fp16:" + layer.name);
                        ...
                        && NcnnWinograd23.CanUse(pack.kernelW, pack.padLeft, pack.inPacks, pack.outPacks))
                    {
                        ...
                        NcnnGpuResourceTracker.RegisterBuffer(pack.packedWeightTm23, wTm.Length, sizeof(float) * 4, "NcnnGraphSession.ConvPackedWeightTm23:" + layer.name);
                ...
                else if (needDepthWiseTexturePack && !UsesQuantizedWeightsForLayer(layer))
                {
                    ...
                    NcnnGpuResourceTracker.RegisterBuffer(pack.packedDepthWiseWeight4, w4.Length, sizeof(float) * 4, "NcnnGraphSession.ConvPackedDepthWiseWeight4:" + layer.name);
                    pack.packedBias4 = new ComputeBuffer(b4.Length, sizeof(float) * 4, ComputeBufferType.Structured);
                    NcnnGpuResourceTracker.RegisterBuffer(pack.packedBias4, b4.Length, sizeof(float) * 4, "NcnnGraphSession.ConvPackedBias4:" + layer.name);
                    pack.packedDepthWiseWeight4.SetData(w4);
                    pack.packedBias4.SetData(b4);
                    if (UsesFp16WeightStorage)
                        pack.packedDepthWiseWeight4Fp16 = NewFp16Vector4Buffer(w4, "NcnnGraphSession.ConvPackedDepthWiseWeight4Fp16:" + layer.name);
                    phaseSw.Stop();
                    packMs += phaseSw.ElapsedMilliseconds;
                }
            ...
            if (layer.type == NcnnLayerTypes.Deconvolution)
            {
                ...
                NcnnGpuResourceTracker.RegisterBuffer(pack.rawWeight, w.Length, sizeof(float), "NcnnGraphSession.DeconvRawWeight:" + layer.name);
                pack.rawBias = new ComputeBuffer(b.Length, sizeof(float), ComputeBufferType.Structured);
                NcnnGpuResourceTracker.RegisterBuffer(pack.rawBias, b.Length, sizeof(float), "NcnnGraphSession.DeconvRawBias:" + layer.name);
            ...
            if (layer.type == NcnnLayerTypes.InnerProduct)
            {
                ...
                if (UsesInt4WeightOnlyForLayer(layer))
                {
                    var quantized = NewInt4WeightOnlyUpload(
                        ...
                        "NcnnGraphSession.InnerProductInt4WeightOnly:" + layer.name);
                ...
                else if (UsesInt8WeightOnlyForLayer(layer))
                {
                    var quantized = NewInt8WeightOnlyUpload(
                        ...
                        ip.inFeatures,
                        outputChannelsAreContiguous: true,
                        "NcnnGraphSession.InnerProductInt8WeightOnly:" + layer.name);
                ...
                else
                {
                    ...
                    NcnnGpuResourceTracker.RegisterBuffer(ip.w, w.Length, sizeof(float), "NcnnGraphSession.InnerProductWeight:" + layer.name);
                    ip.w.SetData(w);
                }
                if (UsesFp16WeightStorage)
                    ip.wFp16 = NewFp16Buffer(w, "NcnnGraphSession.InnerProductWeightFp16:" + layer.name);
                ip.b = new ComputeBuffer(b.Length, sizeof(float), ComputeBufferType.Structured);
                NcnnGpuResourceTracker.RegisterBuffer(ip.b, b.Length, sizeof(float), "NcnnGraphSession.InnerProductBias:" + layer.name);
                ip.b.SetData(b);
                phaseSw.Stop();
                uploadMs += phaseSw.ElapsedMilliseconds;
            ...
            if (layer.type == NcnnLayerTypes.Gemm)
            {
                ...
                if (gp.constantA)
                    throw new InvalidOperationException("Gemm constantA is not supported in NcnnGraphSession: " + layer.name);
                if (!gp.constantB)
                ...
                if (UsesInt4WeightOnlyForLayer(layer))
                {
                    var quantized = NewInt4WeightOnlyUpload(
                        ...
                        "NcnnGraphSession.GemmInt4WeightOnly:" + layer.name);
                ...
                else if (UsesInt8WeightOnlyForLayer(layer))
                {
                    var quantized = NewInt8WeightOnlyUpload(
                        ...
                        gp.constantK,
                        outputChannelsAreContiguous: gp.transB,
                        "NcnnGraphSession.GemmInt8WeightOnly:" + layer.name);
                ...
                if (UsesFp16WeightStorage)
                    gp.bDataFp16 = NewFp16Buffer(gp.bDataCpu, "NcnnGraphSession.GemmWeightFp16:" + layer.name);
                if (gp.cDataCpu != null)
            ...
            if (layer.type == NcnnLayerTypes.MemoryData)
            {
                ...
                NcnnGpuResourceTracker.RegisterBuffer(buf, a.Length, sizeof(float), "NcnnGraphSession.MemoryData:" + layer.name);
                buf.SetData(a);
                phaseSw.Stop();
                uploadMs += phaseSw.ElapsedMilliseconds;
            ...
            if (layer.type == NcnnLayerTypes.Embed)
            {
                ...
                NcnnGpuResourceTracker.RegisterBuffer(ep.w, w.Length, sizeof(float), "NcnnGraphSession.EmbedWeight:" + layer.name);
                ep.w.SetData(w);
                if (b != null)
                {
                    ep.b = new ComputeBuffer(b.Length, sizeof(float), ComputeBufferType.Structured);
                    NcnnGpuResourceTracker.RegisterBuffer(ep.b, b.Length, sizeof(float), "NcnnGraphSession.EmbedBias:" + layer.name);
                    ep.b.SetData(b);
                }
                phaseSw.Stop();
                uploadMs += phaseSw.ElapsedMilliseconds;
            ...
            if (layer.type == NcnnLayerTypes.LayerNorm)
            {
                ...
                if (lp.affine && lp.affineSize > 0)
                {
                    ...
                    NcnnGpuResourceTracker.RegisterBuffer(lp.gamma, gamma.Length, sizeof(float), "NcnnGraphSession.LayerNormGamma:" + layer.name);
                    lp.beta = new ComputeBuffer(beta.Length, sizeof(float), ComputeBufferType.Structured);
                    NcnnGpuResourceTracker.RegisterBuffer(lp.beta, beta.Length, sizeof(float), "NcnnGraphSession.LayerNormBeta:" + layer.name);
            ...
            if (layer.type == NcnnLayerTypes.GroupNorm)
            {
                ...
                if (gp.affine && gp.channels > 0)
                {
                    ...
                    NcnnGpuResourceTracker.RegisterBuffer(gp.gamma, gamma.Length, sizeof(float), "NcnnGraphSession.GroupNormGamma:" + layer.name);
                    gp.beta = new ComputeBuffer(beta.Length, sizeof(float), ComputeBufferType.Structured);
                    NcnnGpuResourceTracker.RegisterBuffer(gp.beta, beta.Length, sizeof(float), "NcnnGraphSession.GroupNormBeta:" + layer.name);
            ...
            if (layer.type == NcnnLayerTypes.BatchNorm)
            {
                ...
                NcnnGpuResourceTracker.RegisterBuffer(bp.biasA4, a4.Length, sizeof(float) * 4, "NcnnGraphSession.BatchNormBiasA4:" + layer.name);
                bp.scaleB4 = new ComputeBuffer(b4.Length, sizeof(float) * 4, ComputeBufferType.Structured);
                NcnnGpuResourceTracker.RegisterBuffer(bp.scaleB4, b4.Length, sizeof(float) * 4, "NcnnGraphSession.BatchNormScaleB4:" + layer.name);
        ...
        {
            return "NcnnGraphSession.RentTempBuffer(" + (member ?? "?") + ":" + line.ToString(CultureInfo.InvariantCulture) + ")";
        }
        ...
        internal void ReturnTempBuffer(ComputeBuffer buffer)
        {
            ...
            if (buffer == null)
                return;
            NcnnGpuResourceTracker.ReleaseBuffer(buffer, "NcnnGraphSession.ReturnTempBuffer");
            ...
            [CallerLineNumber] int callerLine = 0)
        {
            ...
            var allocLabel = "NcnnGraphSession.RentTempArray(" + (callerMember ?? "?") + ":" + callerLine.ToString(CultureInfo.InvariantCulture) + ")";
            ...
            [CallerLineNumber] int callerLine = 0)
        {
            ...
            var allocLabel = "NcnnGraphSession.RentTempMat(" + (callerMember ?? "?") + ":" + callerLine.ToString(CultureInfo.InvariantCulture) + ")";
            var desc = new RenderTextureDescriptor(w, h, format, 0)
            {
        ...
        public void ReturnTempArray(RenderTexture rt)
        {
            if (rt == null)
                return;
            TrackTempRtReturn();
            NcnnGpuResourceTracker.ReleaseTexture(rt, "NcnnGraphSession.ReturnTempArray");
        ...
        public ComputeTexture RentTempArray(CommandBuffer cmd, int w, int h, int depth, RenderTextureFormat format)
        {
            ...
            var allocLabel = "NcnnGraphSession.RentTempArrayCmd(" + w.ToString(CultureInfo.InvariantCulture) + "x" + h.ToString(CultureInfo.InvariantCulture) + "x" + depth.ToString(CultureInfo.InvariantCulture) + ")";
            var temporaryDescriptor = CreateTemporaryRtDescriptor(
                new BufferShape(3, w, h, 1, depth * 4),
                new BufferShape(3, w, h, 1, depth * 4),
                desc,
        ...
        public ComputeTexture RentTempMat(CommandBuffer cmd, int w, int h, RenderTextureFormat format)
        {
            ...
            var id = Shader.PropertyToID(Guid.NewGuid().ToString());
            var allocLabel = "NcnnGraphSession.RentTempMatCmd(" + w.ToString(CultureInfo.InvariantCulture) + "x" + h.ToString(CultureInfo.InvariantCulture) + ")";
            var temporaryDescriptor = CreateTemporaryRtDescriptor(
                new BufferShape(2, w, h, 1, 1),
                new BufferShape(2, w, h, 1, 1),
                desc,
        ...
        public void ReturnTempArray(CommandBuffer cmd, ComputeTexture t)
        {
            ...
            t.isReleased = true;
            TrackTempRtReturn();
            NcnnGpuResourceTracker.ReleaseTextureHandle(t.nameID, t.trackerLabel ?? "NcnnGraphSession.ReturnTempArrayCmd");
        ...
        internal static bool IsStrictLinearMatTexture(TensorRef tensor)
        {
            return tensor != null
                ...
                && tensor.layoutKind == NcnnTextureTensorLayoutKind.LinearMat;
        }
        ...
        internal static NcnnTextureTensorLayoutKind ResolveNcnnTextureLayoutKind(BufferShape logicalShape, BufferShape storageShape, int packs)
        {
            var effectivePacks = Mathf.Max(1, packs);
            if (storageShape.dims <= 2)
                return NcnnTextureTensorLayoutKind.LinearMat;
            ...
            if (logicalShape.dims <= 2 && effectivePacks <= 1 && Mathf.Max(1, storageShape.d) <= 1 && Mathf.Max(1, storageShape.c) <= 1)
                return NcnnTextureTensorLayoutKind.LinearMat;
            return NcnnTextureTensorLayoutKind.Pack4Image;
        }

        internal static NcnnTextureTensor CreateNcnnTextureTensor(
            RenderTexture texture,
            BufferShape logicalShape,
            BufferShape storageShape,
            int packs)
        {
            ...
            var layoutKind = texture.dimension == TextureDimension.Tex2D
                ? NcnnTextureTensorLayoutKind.LinearMat
                : ResolveNcnnTextureLayoutKind(logicalShape, storageShape, packs);

            if (layoutKind == NcnnTextureTensorLayoutKind.LinearMat)
                return new NcnnTextureMat(texture, logicalShape, storageShape, packs);

            var depth = Mathf.Max(1, texture.volumeDepth > 0 ? texture.volumeDepth : 1);
            return new NcnnTextureImageMat(texture, logicalShape, storageShape, packs, depth);
        }
        ...
        {
            return new TensorProvenance("NcnnGraphSession", debugName, blobName, debugName);
        }

        private static TensorPacking ResolveTensorPacking(BufferShape storageShape, NcnnTextureTensorLayoutKind layout, int packCount)
        {
            var packSize = layout == NcnnTextureTensorLayoutKind.Pack4Image
        ...
        internal static NcnnTextureTensorContract GetTextureContract(
            Dictionary<string, BufferShape> textureShapes,
            TensorRef tensor,
            string name)
        {
            ...
            EnsureNcnnTextureTensor(tensor);
            return new NcnnTextureTensorContract(tensor);
        }

        internal static NcnnTextureTensorContract GetCmdTensorContract(
            CmdTensorRef tensor,
        ...
        internal static bool TryGetExistingTextureContract(
            ...
            out NcnnTextureTensorContract contract)
        {
            texture = null;
            contract = default;
        ...
        {
            return UploadImmutableFloatConstants(data, "NcnnGraphSession.NewBuffer");
        }
        ...
        internal static ComputeBuffer NewFp16Buffer(float[] data, string label)
        {
            ...
            NcnnGpuResourceTracker.RegisterBuffer(buffer, packed.Length, sizeof(uint), label ?? "NcnnGraphSession.Fp16Weight");
        ...
        internal static ComputeBuffer NewFp16Vector4Buffer(Vector4[] data, string label)
        {
            ...
            NcnnGpuResourceTracker.RegisterBuffer(buffer, Mathf.Max(1, data.Length), sizeof(uint) * 2, label ?? "NcnnGraphSession.Fp16Weight4");
            buffer.SetData(packed);
            return buffer;
        }
            ...
            string label)
        {
            ...
            NcnnGpuResourceTracker.RegisterBuffer(upload.packedWeights, packed.Length, sizeof(uint), (label ?? "NcnnGraphSession.Int8WeightOnly") + ".PackedInt8");
            NcnnGpuResourceTracker.RegisterBuffer(upload.scales, scales.Length, sizeof(float), (label ?? "NcnnGraphSession.Int8WeightOnly") + ".PerOutputScale");
            ...
            string label)
        {
            ...
            NcnnGpuResourceTracker.RegisterBuffer(upload.packedWeights, data.PackedValues.Length, sizeof(uint), (label ?? "NcnnGraphSession.Int8WeightOnly") + ".PackedInt8Direct");
            NcnnGpuResourceTracker.RegisterBuffer(upload.scales, data.Scales.Length, sizeof(float), (label ?? "NcnnGraphSession.Int8WeightOnly") + ".PerOutputScaleDirect");
            ...
            string label)
        {
            ...
            NcnnGpuResourceTracker.RegisterBuffer(upload.packedWeights, packed.Length, sizeof(uint), (label ?? "NcnnGraphSession.Int4WeightOnly") + ".PackedInt4");
            NcnnGpuResourceTracker.RegisterBuffer(upload.scales, scales.Length, sizeof(float), (label ?? "NcnnGraphSession.Int4WeightOnly") + ".PerOutputScale");
            upload.packedWeights.SetData(packed);
            upload.scales.SetData(scales);
            return upload;
        }
        ...
        internal static void UploadRawConvWeights(ConvPack pack, float[] weights, float[] bias)
        {
            ...
            NcnnGpuResourceTracker.RegisterBuffer(pack.rawWeight, weights.Length, sizeof(float), "NcnnGraphSession.ConvRawWeight");
            pack.rawBias = new ComputeBuffer(bias.Length, sizeof(float), ComputeBufferType.Structured);
            NcnnGpuResourceTracker.RegisterBuffer(pack.rawBias, bias.Length, sizeof(float), "NcnnGraphSession.ConvRawBias");
        ...
        internal static void UploadInt8WeightOnlyConvWeights(ConvPack pack, float[] weights, float[] bias, string layerName)
        {
            ...
            var quantized = NewInt8WeightOnlyUpload(
                ...
                outputChannelsAreContiguous: true,
                "NcnnGraphSession.ConvInt8WeightOnly:" + (layerName ?? string.Empty));
            pack.rawWeightInt8Packed = quantized.packedWeights;
            pack.rawWeightInt8Scales = quantized.scales;
            pack.rawBias = new ComputeBuffer(bias.Length, sizeof(float), ComputeBufferType.Structured);
            NcnnGpuResourceTracker.RegisterBuffer(pack.rawBias, bias.Length, sizeof(float), "NcnnGraphSession.ConvRawBias:" + (layerName ?? string.Empty));
            pack.rawBias.SetData(bias);
        }
        ...
        internal static void UploadInt4WeightOnlyConvWeights(ConvPack pack, float[] weights, float[] bias, string layerName)
        {
            ...
            var quantized = NewInt4WeightOnlyUpload(
                ...
                weights.Length / pack.outC,
                outputChannelsAreContiguous: true,
                "NcnnGraphSession.ConvInt4WeightOnly:" + (layerName ?? string.Empty));
