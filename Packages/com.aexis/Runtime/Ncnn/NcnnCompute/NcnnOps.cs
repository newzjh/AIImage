...
namespace Aexis.Ncnn
{
    ...
    public sealed class NcnnOps : IDisposable
    {
        ...
        public void SentisExpandLinearMat(
            RenderTexture input,
            NcnnGraphSession.BufferShape inShape,
            NcnnGraphSession.BufferShape inStorageShape,
        ...
        public void SentisWhereLinearMat(
            RenderTexture cond,
            NcnnGraphSession.BufferShape condShape,
            NcnnGraphSession.BufferShape condStorageShape,
            RenderTexture a,
            NcnnGraphSession.BufferShape aShape,
            NcnnGraphSession.BufferShape aStorageShape,
            RenderTexture b,
            NcnnGraphSession.BufferShape bShape,
            NcnnGraphSession.BufferShape bStorageShape,
            NcnnGraphSession.BufferShape outShape,
            NcnnGraphSession.BufferShape outStorageShape,
            RenderTexture output)
        {
        ...
        public void SentisGatherLinearMat(
            ...
            NcnnGraphSession.BufferShape dataStorageShape,
            RenderTexture indices,
            NcnnGraphSession.BufferShape indicesShape,
            NcnnGraphSession.BufferShape indicesStorageShape,
            int axis,
            NcnnGraphSession.BufferShape outShape,
            NcnnGraphSession.BufferShape outStorageShape,
            RenderTexture output)
        ...
        public void CastPack4(RenderTexture input, NcnnGraphSession.BufferShape shape, int typeFrom, int typeTo, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void CastPack4(CommandBuffer cmd, ComputeTexture input, NcnnGraphSession.BufferShape shape, int typeFrom, int typeTo, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void QuantizePack4(RenderTexture input, NcnnGraphSession.BufferShape shape, ComputeBuffer scale, int scaleDataSize, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
        ...
        public void QuantizePack4(CommandBuffer cmd, ComputeTexture input, NcnnGraphSession.BufferShape shape, ComputeBuffer scale, int scaleDataSize, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (scale == null) throw new ArgumentNullException(nameof(scale));
        ...
        public void DequantizePack4(RenderTexture input, NcnnGraphSession.BufferShape shape, ComputeBuffer scale, int scaleDataSize, ComputeBuffer bias, int biasDataSize, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (scale == null) throw new ArgumentNullException(nameof(scale));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void DequantizePack4(CommandBuffer cmd, ComputeTexture input, NcnnGraphSession.BufferShape shape, ComputeBuffer scale, int scaleDataSize, ComputeBuffer bias, int biasDataSize, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (scale == null) throw new ArgumentNullException(nameof(scale));
        ...
        public void RequantizePack4(
            RenderTexture input,
            NcnnGraphSession.BufferShape shape,
            ComputeBuffer scaleIn,
            int scaleInDataSize,
            ComputeBuffer scaleOut,
            int scaleOutDataSize,
        ...
        public void RmsNormPack4(RenderTexture input, NcnnGraphSession.BufferShape shape, ComputeBuffer gamma, int affineSize, bool affine, float eps, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void RmsNormPack4(CommandBuffer cmd, ComputeTexture input, NcnnGraphSession.BufferShape shape, ComputeBuffer gamma, int affineSize, bool affine, float eps, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void RmsNormPack4LinearMat(RenderTexture input, NcnnGraphSession.BufferShape shape, ComputeBuffer gamma, int affineSize, bool affine, float eps, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void RmsNormPack4LinearMat(CommandBuffer cmd, ComputeTexture input, NcnnGraphSession.BufferShape shape, ComputeBuffer gamma, int affineSize, bool affine, float eps, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        private void SetQuantShapeParams(NcnnGraphSession.BufferShape shape)
        {
        ...
        private void SetQuantShapeParams(CommandBuffer cmd, NcnnGraphSession.BufferShape shape)
        {
        ...
        private void SetNormShapeParams(NcnnGraphSession.BufferShape shape)
        {
        ...
        private void SetNormShapeParams(CommandBuffer cmd, NcnnGraphSession.BufferShape shape)
        {
        ...
        private void SetRmsNormShapeParams(NcnnGraphSession.BufferShape shape)
        {
        ...
        private void SetRmsNormShapeParams(CommandBuffer cmd, NcnnGraphSession.BufferShape shape)
        {
        ...
        private void SetRotaryCacheShapeParams(NcnnGraphSession.BufferShape cosShape, NcnnGraphSession.BufferShape sinShape)
        {
        ...
        private void SetRotaryCacheShapeParams(CommandBuffer cmd, NcnnGraphSession.BufferShape cosShape, NcnnGraphSession.BufferShape sinShape)
        {
        ...
        public void RotaryEmbedPack4(
            ...
            NcnnGraphSession.BufferShape shape,
            RenderTexture cos,
            NcnnGraphSession.BufferShape cosShape,
            RenderTexture sin,
            NcnnGraphSession.BufferShape sinShape,
            bool interleaved,
            RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
        ...
        private static int ResolveTileArrayDepth(NcnnGraphSession.BufferShape shape)
        {
        ...
        public void TilePack4(RenderTexture input, NcnnGraphSession.BufferShape inShape, NcnnGraphSession.BufferShape outShape, Vector4Int repeats, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void TilePack4(CommandBuffer cmd, ComputeTexture input, NcnnGraphSession.BufferShape inShape, NcnnGraphSession.BufferShape outShape, Vector4Int repeats, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void TileLinearMat(RenderTexture input, NcnnGraphSession.BufferShape inShape, NcnnGraphSession.BufferShape inStorageShape, NcnnGraphSession.BufferShape outShape, NcnnGraphSession.BufferShape outStorageShape, Vector4Int repeats, RenderTexture output)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
        ...
        public void TileLinearMat(CommandBuffer cmd, ComputeTexture input, NcnnGraphSession.BufferShape inShape, NcnnGraphSession.BufferShape inStorageShape, NcnnGraphSession.BufferShape outShape, NcnnGraphSession.BufferShape outStorageShape, Vector4Int repeats, ComputeTexture output)
        {
            if (cmd == null) throw new ArgumentNullException(nameof(cmd));
            if (input == null) throw new ArgumentNullException(nameof(input));
            if (output == null) throw new ArgumentNullException(nameof(output));
