...
public sealed class NcnnInt8RunnerComparisonTests
{
    ...
    private static async UniTask<NcnnInt8RunnerComparisonCase> RunMattingComparisonAsync()
    {
        ...
        try
        {
            fp32 = await RunMattingAsync(input, AexisPrecisionMode.FP32);
            fp16 = await RunMattingAsync(input, AexisPrecisionMode.FP16);
            int8 = await RunMattingAsync(input, AexisPrecisionMode.INT8Selective);
    ...
    private static async UniTask<NcnnInt8RunnerComparisonCase> RunYoloComparisonAsync()
    {
        ...
        try
        {
            fp32 = await RunYoloAsync(input, AexisPrecisionMode.FP32);
            fp16 = await RunYoloAsync(input, AexisPrecisionMode.FP16);
            int8 = await RunYoloAsync(input, AexisPrecisionMode.INT8Selective);
    ...
    private static async UniTask<NcnnInt8RunnerComparisonCase> RunClipComparisonAsync()
    {
        ...
        try
        {
            fp32 = await RunClipAsync(input, AexisPrecisionMode.FP32);
            fp16 = await RunClipAsync(input, AexisPrecisionMode.FP16);
            int8 = await RunClipAsync(input, AexisPrecisionMode.INT8Selective);
    ...
    private static async UniTask<MattingRun> RunMattingAsync(Texture2D input, AexisPrecisionMode precision)
    {
        var previousTracker = AexisGpuResourceTracker.Enabled;
        AexisGpuResourceTracker.Enabled = true;
        AexisGpuResourceTracker.Reset("int8-runner-matting-" + precision);
    ...
    private static async UniTask<YoloRun> RunYoloAsync(Texture2D input, AexisPrecisionMode precision)
    {
        var previousTracker = AexisGpuResourceTracker.Enabled;
        AexisGpuResourceTracker.Enabled = true;
        AexisGpuResourceTracker.Reset("int8-runner-yolo-" + precision);
    ...
    private static async UniTask<ClipRun> RunClipAsync(Texture2D input, AexisPrecisionMode precision)
    {
        var previousTracker = AexisGpuResourceTracker.Enabled;
        AexisGpuResourceTracker.Enabled = true;
        AexisGpuResourceTracker.Reset("int8-runner-clip-" + precision);
        ...
        string manifestFileName)
    {
        ...
        var manifest = AexisModelManifestLoader.LoadFromFile(manifestPath);
