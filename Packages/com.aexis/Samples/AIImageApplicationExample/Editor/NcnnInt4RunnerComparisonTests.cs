...
public sealed class NcnnInt4RunnerComparisonTests
{
    ...
    private static async UniTask<NcnnInt4RunnerComparisonCase> RunMattingComparisonAsync()
    {
        ...
        try
        {
            ...
            int4 = await RunMattingAsync(input, AexisPrecisionMode.INT4Selective);
    ...
    private static async UniTask<NcnnInt4RunnerComparisonCase> RunYoloComparisonAsync()
    {
        ...
        try
        {
            ...
            int4 = await RunYoloAsync(input, AexisPrecisionMode.INT4Selective);
    ...
    private static async UniTask<NcnnInt4RunnerComparisonCase> RunClipComparisonAsync()
    {
        ...
        try
        {
            ...
            int4 = await RunClipAsync(input, AexisPrecisionMode.INT4Selective);
    ...
    private static async UniTask<MattingRun> RunMattingAsync(Texture2D input, AexisPrecisionMode precision)
    {
        ...
        AexisGpuResourceTracker.Reset("int4-runner-matting-" + precision);
    ...
    private static async UniTask<YoloRun> RunYoloAsync(Texture2D input, AexisPrecisionMode precision)
    {
        var previousTracker = AexisGpuResourceTracker.Enabled;
        AexisGpuResourceTracker.Enabled = true;
        AexisGpuResourceTracker.Reset("int4-runner-yolo-" + precision);
    ...
    private static async UniTask<ClipRun> RunClipAsync(Texture2D input, AexisPrecisionMode precision)
    {
        var previousTracker = AexisGpuResourceTracker.Enabled;
        AexisGpuResourceTracker.Enabled = true;
        AexisGpuResourceTracker.Reset("int4-runner-clip-" + precision);
