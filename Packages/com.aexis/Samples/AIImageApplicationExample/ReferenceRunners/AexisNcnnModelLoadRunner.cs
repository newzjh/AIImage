...
namespace Aexis.Samples
{
    ...
    public sealed class AexisNcnnModelLoadRunner : MonoBehaviour
    {
        ...
        public event Action<AexisGraphSession> ModelLoaded;
        public event Action<Exception> ModelLoadFailed;

        public AexisGraphSession Session { get; private set; }
        ...
        public async UniTask LoadAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Session = NcnnInferenceSessionFactory.Create(new AexisOps());
        ...
        private void ReportProgress(AexisGraphSession.LoadProgress progress)
        {
