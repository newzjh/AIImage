...
namespace AIImage.Qwen35
{
    ...
    public sealed class Qwen35NetworkLoader : IDisposable
    {
        ...
        public Qwen35NetworkLoader(AexisOps ops = null)
        {
            _ops = ops ?? new AexisOps();
            _ownsOps = ops == null;
        }

        public Qwen35NetworkLoadResult LoadAndRelease(Qwen35NetworkAsset asset, Action<AexisGraphSession.LoadProgress> progress = null)
        {
            ...
            try
            {
                ...
                using (var repro = new AexisGraphSession(_ops))
                {
        ...
        public IReadOnlyList<Qwen35NetworkLoadResult> ValidateAllSequential(Qwen35NetworkAssetCatalog catalog, Action<string, AexisGraphSession.LoadProgress> progress = null)
        {
