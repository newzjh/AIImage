...
Three 2026-07-30 one-click Test reports now cover the 600 x 337 input. macOS Editor on macOS 15.3.1 / Mac16,10 / Apple M4 / 16 GB / Unity 6000.2.7f2 / Metal passed CLIP in 11,755 ms, CodeFormer in 15,332 ms, GFPGAN in 4,696 ms, Real-ESRGAN in 1,295 ms, Matting in 2,182 ms, YOLO in 986 ms (two people, 78.69% mask), and YOLO + DeepFillV2 in 13,811 ms. macOS Player on the same machine passed the same runners in 97 ms, 2,515 ms, 1,136 ms, 707 ms, 421 ms, 294 ms (two people, 78.69% mask), and 3,528 ms respectively. Qwen3.5 Q4 and SD inpainting were skipped in both reports because their model groups were absent.

The iPadOS 18.3 Simulator (`iPad8,6` profile) on an Apple M4 / 16 GB host passed CLIP in 111 ms, CodeFormer in 2,974 ms, GFPGAN in 1,336 ms, Real-ESRGAN in 903 ms, Matting in 486 ms, YOLO in 475 ms (two people, 78.69% mask), and YOLO + DeepFillV2 in 4,731 ms. Qwen3.5 Q4 and SD inpainting were also skipped because their model groups were absent. This is simulator evidence, not a physical-device benchmark; physical iOS validation remains pending. Use the [Apple runtime smoke guide](apple-runtime-smoke.md) for the remaining target-machine evidence.
