...
#if !NETCF_1_0 && !NETFX_CORE
using System.Security.Cryptography;
using Aexis.Samples.SharpZipLib.Encryption;
#endif

using Aexis.Samples.SharpZipLib.Core;
using Aexis.Samples.SharpZipLib.Checksums;
using Aexis.Samples.SharpZipLib.Zip.Compression.Streams;
using Aexis.Samples.SharpZipLib.Zip.Compression;

namespace Aexis.Samples.SharpZipLib.Zip 
{
	...
	/// using System.IO;
	/// 
	/// using Aexis.Samples.SharpZipLib.Zip;
	/// 
	/// class MainClass
	/// {
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="Aexis.Samples.SharpZipLib.Zip.ZipException">
...
#if !NET_1_1 && !NETCF_2_0 && !NETFX_CORE
